...
$sql_inserta=mysql_query("insert into ingreso_almacenes values($codigo,$global_almacen,$tipo_ingreso,'$fecha_real','$hora_sistema','$observaciones',1,0,'$nota_entrega','$nro_correlativo',0,0)");
...
{	$cod_material=$vector_material[$i];
	...
	$sql_inserta2=mysql_query("insert into ingreso_detalle_almacenes values($codigo,'$cod_material','$numero_lote','$fecha_sistema_vencimiento',$cantidad,$cantidad)");
}
