...
where s.cod_tiposalida=ts.cod_tiposalida and s.cod_almacen='$global_almacen' and s.cod_salida_almacenes='$codigo_salida' and s.grupo_salida=2";
...
while($dat_detalle=mysql_fetch_array($resp_detalle)) {	
	...
	while($dat_salida_ingresos=mysql_fetch_array($resp_salida_ingresos)) {	
		...
		$detalle_ingreso="$detalle_ingreso<tr><td align='center' width='25%'>$codigo_ingreso</td><td width='25%'>&nbsp;$nro_lote_ingreso</td><td align='center' width='25%'>$cantidad_unitaria_ingreso</td><td align='center' width='25%'>$fecha_vencimiento</td></tr>";
	}
