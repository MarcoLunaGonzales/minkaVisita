...
{	var rpt_visitador,rpt_gestion, rpt_ciclo;
	...
	window.open('rpt_central_coberturaCategoria.php?rpt_visitador='+rpt_visitador+'&rpt_gestion='+rpt_gestion+'&rpt_ciclo='+rpt_ciclo+'&rpt_territorio='+rpt_territorio+'','','scrollbars=yes,status=no,toolbar=no,directories=no,menubar=no,resizable=yes,width=1000,height=800');
	return(true);
}
...
{	var rpt_visitador,rpt_gestion, rpt_ciclo;
	...
	window.open('rpt_central_coberturaCategoriaResumen.php?rpt_territorio='+rpt_territorio+'&rpt_gestion='+rpt_gestion+'&rpt_ciclo='+rpt_ciclo+'','','scrollbars=yes,status=no,toolbar=no,directories=no,menubar=no,resizable=yes,width=1000,height=800');
	return(true);
}
...
echo "<center><table class='textotit'><tr><th>Reporte de Cobertura x Visitador</th></tr></table><br>";
echo"<form method='post'>";
	...
	echo"\n </table><br>";
	//echo "<center><input type='button' name='reporte' value='Resumen' onClick='envia_formularioResumen(this.form)' class='boton'>";
	echo "<input type='button' name='reporte' value='Detallado' onClick='envia_formulario(this.form)' class='boton'></center>";
	echo"</form>";
?>