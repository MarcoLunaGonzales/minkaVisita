...
echo "<script language='Javascript'>
	...
	echo "<center><table border='0' class='textotit'><tr><td align='center'>Registro de Rutero M&eacute;dico Maestro<br>N&uacute;mero de Rutero: $nombre_rutero</td></tr></table></center><br>";
	...
	echo "<tr><th>&nbsp;</th><th>D&iacute;a Contacto</th><th>Turno</th><th>Contactos</th></tr>";
	while($dat=mysql_fetch_array($resp))
	{
		...
		$sql1="select c.orden_visita, m.ap_pat_med, m.ap_mat_med, m.nom_med, d.direccion, c.cod_especialidad, c.categoria_med, c.estado
		 ...
		 $sql1 = " select c.orden_visita, c.cod_especialidad,c.categoria_med,  m.ap_pat_med, m.ap_mat_med, m.nom_med, d.direccion
                                             from rutero_maestro_detalle c, medicos m, direcciones_medicos d where c.cod_contacto=$cod_contacto and c.cod_visitador=$global_visitador
                                             and c.cod_med=m.cod_med and m.cod_med=d.cod_med order by c.orden_visita  ";
//		echo $sql1;			
		$resp1=mysql_query($sql1);
		$contacto="<table class='textomini' width='100%'>";
		$contacto=$contacto."<tr><th width='5%'>Orden</th><th width='40%'>M&eacute;dico</th><th width='10%'>Especialidad</th><th width='10%'>Categor&iacute;a</th><th width='40%'>Direcci&oacute;n</th></tr>";
