...
echo "</table>";
if($grupo_ingreso==1)
{	echo"\n<table align='center'><tr><td><a href='navegador_ingresomuestrastransito.php'><img border='0' src='imagenes/volver.gif' width='15' height='8'>Volver Atras</a></td></tr></table>";
}	
else
{	echo"\n<table align='center'><tr><td><a href='navegador_ingresomaterialapoyotransito.php'><img border='0' src='imagenes/volver.gif' width='15' height='8'>Volver Atras</a></td></tr></table>";
}
