...
<?php
	...
	$codFuncionario=$_SESSION['promotorTrabajo'];
	$nombreLinea=$_GET['linea'];
	
?>
<div>	
	<h1>Reporte Avance de Presupuestos Regional x Producto</h1>
...
<table class="texto">
	...
	$sql="select pp.cod_producto, pp.nombre_producto, sum(p.monto_presupuesto), sum(p.cantidad_presupuesto) from presupuestos p, productos pp
		...
		p.cod_ciudad='$codRegional' and pp.linea='$nombreLinea' group by pp.cod_producto, pp.nombre_producto order by 1";
