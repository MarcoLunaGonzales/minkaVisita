<?php
	...
	where s.cod_tiposalida=ts.cod_tiposalida and s.cod_almacen='$global_almacen' and 
	s.cod_salida_almacenes='$codigo_salida' and s.grupo_salida=$grupoSalida";

	$resp=mysql_query($sql);

	echo "<h1>Nota de Remision</h1>";
	
	echo "<center><table class='texto'>";
	echo "<tr><th>Nro. de Salida</th><th>Fecha</th><th>Tipo de Salida</th><th>Observaciones</th></tr>";
	...
	echo "<tr><th>&nbsp;</th><th>Muestra</th><th>Cantidad</th><th>Detalle<table class='texto'>
	<tr><th width='25%'>Nro. Ingreso</th><th width='25%'>Nro. Lote</th><th width='25%'>Cantidad Unitaria</th>
	<th width='25%'>Fecha de Vencimiento</th></tr></table></th></tr>";
	...
	if($grupoSalida==1){
		...
		$sql_detalle="select s.cod_material, s.cantidad_unitaria, m.descripcion_material from salida_detalle_almacenes s, material_apoyo m 
		where s.cod_salida_almacen='$codigo_salida' and s.cantidad_unitaria>0 and m.codigo_material=s.cod_material order by 3";	
	}
	...
	{	$cod_material=$dat_detalle[0];
		...
		if($grupoSalida==1){
			$sql_nombre_material="select concat(descripcion,' ',presentacion) from muestras_medicas where codigo='$cod_material'";
		}else{
