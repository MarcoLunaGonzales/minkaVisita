...
{	echo "<center><table border='0' class='textotit'><tr><th>Frecuencias de Visita<br>Territorio: $nombre_territorio</th></tr></table></center><br>";
	...
	{	$sql_medicos_asignados="select m.cod_med, m.ap_pat_med, m.ap_mat_med, m.nom_med from medicos m, categorias_lineas c where 
		m.cod_ciudad='$rpt_territorio' and m.cod_med=c.cod_med and c.codigo_linea='$global_linea' order by m.ap_pat_med, m.ap_mat_med";
		...
		while($dat=mysql_fetch_array($resp_medicos_asignados))
		{
			...
			where r.cod_contacto=rd.cod_contacto and r.cod_ciclo='$ciclo_global' and r.codigo_linea='$linea_rpt' and r.codigo_gestion='$codigo_gestion' and rd.cod_med='$codigo_medico'";
...
if($frecuencia_visita!="")
{	echo "<center><table border='0' class='textotit'><tr><th>Frecuencias de Visita: $frecuencia_visita<br>Territorio: $nombre_territorio</th></tr></table></center><br>";
