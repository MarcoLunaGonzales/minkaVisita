...
<head>
    ...
    jQuery(document).ready(function($) {
        ...
        var valores = '', valores2 = '', valores_finales = '';
        $("#enviar").click(function(){
            $(".sacar").each(function(index){
                valores1 = $("input.para_actualizar",this).val();
                valores2 = $("input.cantidad_actualizar",this).val();
                valores_finales += valores1+"-"+valores2+",";
            })
            $.ajax({
                type: "POST",
                url: "ajax/asignacion_productos/guardar_cantidades.php",
                dataType : 'json',
                data: { 
                    cadena: valores_finales
                }
            }).done(function() { 
                ...
                window.location.href = "asignacion_productos_p2_nueva_vista_preliminar.php?territorios="+territorios+"&ciclo_gestion="+ciclo_gestion;
            });
        })
    });
    </script>
...
<body>
    <div id="container">
        ...
        <header id="titulo" style="min-height: 50px">
            <h3 style="color: #5F7BA9; font-size: 1.5em; font-family: Vernada">Asignaci&oacute;n de MM</h3>
        </header>
        <?php 
            ...
            <div class="row">
                ...
                while ($row_linea_asignada = mysql_fetch_array($sql_linea_asignada)) {
                    ...
                    <div class="four columns end">
                        ...
                        <?php  
                        $sql_productos = mysql_query("SELECT a.posicion, a.producto, CONCAT(m.descripcion,' ',m.presentacion) as producto_nom, a.id, a.linea from asignacion_de_porducto_detalle a, asignacion_de_prodcutos ac, muestras_medicas m where a.id = ac.id and m.codigo = a.producto and ac.ciudad = $row_ciudades[0] and ac.gestion = $gestionn and ac.ciclo = $ciclo and a.linea = $row_linea_asignada[0] ORDER BY 1 ASC");
                        ?>
                        <table border="1">
                            <tr>
                                <th>Posicion</th>
                            ...
                            <tr class="sacar">
                                ...
                                <td><input type="hidden" value="<?php echo $row_productos[3]."-".$row_productos[4]."-".$row_productos[1]."-".$row_productos[0]; ?>" class="para_actualizar" /><input type="text" class="cantidad_actualizar" /></td>
                            </tr>
                            <?php } ?>
                        </table>
                    </div>
