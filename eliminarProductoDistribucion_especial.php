...
echo "<form name='form1' action='guardaEliminarProductoDistribucion_especial.php' method='post'>";
...
echo "
<input type='hidden' name='codCicloDist' value='$global_linea_distribucion'>
...
Ciclo: <strong>$global_linea_distribucion</strong> Gesti&oacute;n: <strong>$nombre_gestion</strong></td></tr></table></center><br>";
