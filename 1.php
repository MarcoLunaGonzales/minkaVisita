...
*/
	...
	echo "<td>Seleccione el Turno:  <select class='texto' name='turno'>";
	if($turno="am")
	...
	echo "<tr><td>Direcciòn</td><td><select class='texto' name='h_cod_zona'>";
	...
	echo "<td>Categorìa</td><td><input type='text' class='texto' size='5' name='h_categoria_med' value='$p_categoria_med' disabled='true'></td></tr></table></center>";
	...
	echo "<center><table bordercolor='#00a893' span class='texto' border='1' cellspacing='0'><tr><td>Muestras</td><td>   </td><td>Cantidad</td></tr>";
