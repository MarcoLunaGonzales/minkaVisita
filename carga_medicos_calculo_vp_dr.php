    ...
    $(document).ready(function(){
                ...
                var n = noty({
                    ...
                    buttons: [{
                        ...
                        onClick: function($noty) {
                            $noty.close();
                            $.getJSON("ajax/cargaBanco/carga_dr.php",{
                                "valores" : valores
                            },response);
                        }
                    },{
        ...
        function response(datos){
            if(datos.estado == 'bien'){
                alert(datos.mensaje)
                window.location.href = "calculo_banco_muestras_apro.php";
            }
            if(datos.estado == 'mal'){
                alert(datos.mensaje)
            }
    ...
    <div id="container">
                                                ...
                                                while ($row_muestras = mysql_fetch_array($sql_muestra)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="center">
                                                            ...
                                                            ?>
                                                            <input type="text" value="<?php echo $canti; ?>" class="cantidad_para_validar">
                                                        </td>
        ...
        <center>
            <div class="two columns centered">
                <a href="javascript:void(0)" class="button" id="enviar">Aprobar</a>
            </div>
        </center>
    </section>
</div>
