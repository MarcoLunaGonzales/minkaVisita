...
echo "<center><table class='textotit'><tr><th>Cantidad de MM y MA Visitadas</th></tr></table><br>";
echo"<form method='post'>";
	...
	echo "<option value='0' selected>Todas las Lineas</option>";
	...
	$sql_gestion="select codigo_gestion, nombre_gestion, estado from gestiones where codigo_linea='1006'";
	...
	if($gestion_rpt=="")
	{	$sql_ciclo="select cod_ciclo, estado from ciclos where codigo_linea='1006' and codigo_gestion='$cod_gestion_rpt' order by cod_ciclo desc";
	}
	else
	{	$sql_ciclo="select cod_ciclo, estado from ciclos where codigo_linea='1006' and codigo_gestion='$gestion_rpt' order by cod_ciclo desc";
	}
