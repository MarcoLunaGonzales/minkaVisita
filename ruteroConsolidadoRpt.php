<?php
	...
	list($codCiclo, $codGestion, $nomGestion)=explode("|",$gestionCicloRpt);
	$visitador=$_GET['rpt_visitador'];
	$vista=$_GET['vista'];
	...
	echo "<center><table border='0' class='textotit'><tr><th>Rutero Medico Maestro Consolidado
		<br>Visitador: $nombre_funcionario<br>Gestion: $nomGestion Ciclo: $codCiclo</th></tr></table></center><br>";
