...
*/	
	...
	echo "<tr><td align='center'>Grillas</center></td></tr></table><br>";
	echo "<center><table border='1' cellspacing='0' class='texto'>";
	echo "<tr><th>Nombre Grilla</th><th>Territorio</th><th>Fecha de Creación</th><th>Fecha de Modificación</th><th>&nbsp</th></tr>";
	...
	$dat=mysql_fetch_array($resp);
		...
		$fecha_modi=$dat[8];
			...
			$ciudad=$dato[1];	
		echo "<tr><td align='center'>$nombre</td><td align='center'>$ciudad</td><td align='center'>$fecha_creacion</td><td align='center'>$fecha_modi</td></tr>";
	echo "</table><br>";
	...
	echo "</table><br>";
	echo "<a href='navegador_grillas.php?cod_ciudad=$cod_ciudad'><--Volver Atras</a>";
?>