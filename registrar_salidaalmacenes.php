...
echo "<script language='Javascript'>
	...
	function validar(f)
	{
		...
		location.href='guarda_salidaalmacenes.php?vector_material='+vector_material+'&vector_fechavenci='+vector_fechavenci+'&vector_cantidades='+vector_cantidades+'&fecha='+fecha+'&tipo_salida='+tipo_salida+'&observaciones='+observaciones+'&cantidad_material='+cantidad_material+'&almacen='+almacen+'&funcionario='+funcionario+'&territorio='+territorio+'';
	}
	</script>";
...
echo "<table border='0' class='textotit' align='center'><tr><td>Adicionar Salida de Almacen</td></tr></table><br>";
...
echo "<tr><td align='center'>";
	echo"<INPUT type='text' class='texto' value='$fecha' id='fecha' size='20' name='fecha'>";
...
$sql1="select cod_tiposalida, nombre_tiposalida from tipos_salida order by nombre_tiposalida";
...
echo "<tr><th colspan='4'>Cantidad de Materiales a sacar:  <select name='cantidad_material' OnChange='enviar_form(this.form)' class='texto'>";
for($i=0;$i<=15;$i++)
...
echo "</select><th></tr>";
echo "<tr><th width='5%'>&nbsp;</th><th width='70%'>Material</th><th width='25%'>Fecha Vencimiento</th><th width='25%'>Cantidad Unitaria</th></tr>";
...
echo "</table>";
echo"\n<table align='center'><tr><td><a href='navegador_salidaalmacenes.php'><img  border='0'src='imagenes/back.png' width='40'></a></td></tr></table>";
