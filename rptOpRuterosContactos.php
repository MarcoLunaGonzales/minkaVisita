...
{	var rpt_visitador,rpt_gestion, rpt_ciclo;
	...
	window.open('rptRuterosContactos.php?rpt_gestion='+rpt_gestion+'&rpt_ciclo='+rpt_ciclo+'&rpt_territorio='+rpt_territorio+'','','scrollbars=yes,status=no,toolbar=no,directories=no,menubar=no,resizable=yes,width=1000,height=800');
	return(true);
}
</script>
<?php
...
echo "<center><table class='textotit'><tr><th>Contactos Promedio/Dia en Rutero</th></tr></table><br>";
