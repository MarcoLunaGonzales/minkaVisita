<?php
	...
	$sql="select distinct m.cod_med,m.ap_pat_med,m.ap_mat_med,m.nom_med
		 ...
		 where m.cod_ciudad='$global_agencia' and m.cod_med=c.cod_med and c.cod_especialidad='$cod_espe'
		 and m.cod_med=v.cod_med and v.codigo_visitador='$visitador' and c.codigo_linea=$global_linea 
		 and v.codigo_linea='$global_linea' order by m.ap_pat_med";
