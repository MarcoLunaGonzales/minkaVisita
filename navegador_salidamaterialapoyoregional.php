...
echo "<script language='Javascript'>
		function enviar_nav()
		{	location.href='registrar_salidamaterialregional.php';
		}
	...
	where s.cod_tiposalida=ts.cod_tiposalida and s.cod_almacen='$global_almacen' and c.cod_ciudad=s.territorio_destino and a.cod_almacen=s.cod_almacen and s.grupo_salida='2'";
	...
	while($dat=mysql_fetch_array($resp))
	{
		...
		echo "<tr><td align='center'>$codigo</td><td align='center'>$fecha_salida_mostrar</td><td>$nombre_tiposalida</td><td>$nombre_ciudad</td><td>&nbsp;$nombre_almacen</td><td>&nbsp;$nombre_funcionario</td><td>&nbsp;$obs_salida</td><td><a target='_BLANK' href='navegador_detallesalidamaterialregional.php?codigo_salida=$codigo'><img src='imagenes/detalles.gif' border='0' alt='Ver Detalles de la Salida'> Detalles</a></td></tr>";		
	}
