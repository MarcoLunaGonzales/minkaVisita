...
*/
	...
	echo "<center><table border='0' class='textotit'><tr><th>Nota de Remisión Material de Apoyo</th></tr></table></center><br>";
	...
	{	$cod_material=$dat_detalle[0];
		...
		echo "<tr><td align='center'>$indice</td><td align='left'>$nombre_material</td><td align='center'>$cantidad_unitaria</td></tr>";
		$indice++;
	}
	echo "</table>";
