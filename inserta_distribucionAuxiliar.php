...
{	require("estilos_inicio_adm.inc");
	...
	f.cod_cargo='1011' and f.estado=1	and f.cod_ciudad=$codTerritorio order by fl.codigo_funcionario";
...
echo "COMPLETADOOOOOOOOOOOOOOOOOOOOOO";
