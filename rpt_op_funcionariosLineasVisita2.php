<script language='JavaScript'>
    ...
    {	var j,i;
        ...
        window.open('rpt_funcionariosLineasVisita2.php?rpt_territorio='+rpt_territorio,'','scrollbars=yes,status=no,toolbar=no,directories=no,menubar=no,resizable=yes,width=1000,height=800');
        return(true);
    }
</script>
<?php
