...
$sqlLineas="select l.codigo_linea, l.nombre_linea from lineas l where l.estado=1 and l.linea_promocion=1 and 
l.codigo_linea in (1042)";
...
while($datLineas=mysql_fetch_array($respLineas)){
	...
	rd.cod_med in (4585,1623990,1627553,4585,1627553,1628559,1627602)";
