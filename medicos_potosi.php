...
$sql_busca="select paterno, materno, nombres, fecha_nac, telefono, celular, email, hobbie, estado_civil, perfil, 
			...
			from medicos_potosi order by paterno";
echo $sql_busca;
...
{	$paterno=$dat_busca[0];
	...
	$sql_inserta="insert into medicos values('$codigo','$paterno','$materno','$nombres','$fecha_nac','$telefono','$celular','$email','$hobbie','$estado_civil','$secretaria','$perfil_psico','119')";
