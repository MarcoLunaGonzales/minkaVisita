...
{	var rpt_visitador,rpt_gestion, rpt_ciclo;
	...
	window.open('rptAsesoria.php?rpt_visitador='+rpt_visitador+'&rpt_gestion='+rpt_gestion+'&rpt_ciclo='+rpt_ciclo+'&rpt_territorio='+rpt_territorio,'','scrollbars=yes,status=no,toolbar=no,directories=no,menubar=no,resizable=yes,width=1000,height=800');
	return(true);
}
...
{	var rpt_visitador,rpt_gestion, rpt_ciclo;
	...
	window.open('rptAsesoriaResumen.php?rpt_visitador='+rpt_visitador+'&rpt_gestion='+rpt_gestion+'&rpt_ciclo='+rpt_ciclo+'&rpt_territorio='+rpt_territorio,'','scrollbars=yes,status=no,toolbar=no,directories=no,menubar=no,resizable=yes,width=1000,height=800');
	return(true);
}
...
echo "<center><table class='textotit'><tr><th>Reporte de Asesorias en Consultorio</th></tr></table><br>";
echo"<form method='post'>";
	...
	<td>
	<select name='rpt_territorio' class='texto' onChange='ajaxVisitadorLinea(this);' size='12' multiple>";
	...
	echo"\n </table><br>";
	echo "<center><input type='button' name='reporte' value='Detallado' onClick='envia_formulario(this.form)' class='boton'>";
	echo "<input type='button' name='reporte' value='Resumido' onClick='envia_formulario2(this.form)' class='boton'></center><br>";
	echo"</form>";
?>