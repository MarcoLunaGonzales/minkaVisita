...
$sql_busca="select paterno, materno, nombres, fecha_nac, telefono, celular, email, hobbie, estado_civil, perfil, 
			...
			from medicosnuevos_sucre order by paterno";
echo $sql_busca;
...
{	$paterno=$dat_busca[0];
	...
	$sql_inserta_zonas="insert into direcciones_medicos values('$codigo','$zona_1','$direccion1','Consultorio I',1)";
	$resp_inserta_zonas=mysql_query($sql_inserta_zonas);
	if($zona2!="")
	{	$sql_inserta_zonas2="insert into direcciones_medicos values('$codigo','$zona_2','$direccion2','Consultorio II',2)";
