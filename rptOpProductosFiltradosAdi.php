...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
            ...
            $(function() {
                $("#enviar").click(function(event){
                    ...
                    if(territorio == '' || territorio == null){
                        ...
                        var url = "rptProductosFiltradosAdi.php?territorio="+territorio+"&formato="+formato;
                        var windowName = "Reporte Productos Quitados y Adicionados por medicos";//$(this).attr("name");
    ...
    <body>
        <div id="container">
            <div id="header">
                <center>
                    <h2>Productos Quitados y Adicionados por Medico</h2>
                </center>
            </div>
            <div id="content">
                <center>
                    <table border="1" width="30%" cellpadding="5" id="filtro">
                        ...
                        <tr>
                            ...
                            <td>
                                Quitados
                                <input type="radio" checked="" value="Quitados" name="formato" />
                                Adicionados
                                <input type="radio" value="Adicionados" name="formato" />
                            </td>
                        </tr>
                    </table>
                </center>
