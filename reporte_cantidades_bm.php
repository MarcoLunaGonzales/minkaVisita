...
<head>
    ...
    jQuery(document).ready(function($) {
        $("#continuar").click(function(){
            var url,territorios,ciclo_inicio,ciclo_destino;
            ciclo_inicio = $("#ciclo_inicio").val();
            ciclo_destino = $("#ciclo_destino").val();
            url = $("#continuar").attr('rel');
            territorios = $("#territorio").val();
            window.location.href = url+"?&territorios="+territorios+"&ciclo_inicio="+ciclo_inicio+"&ciclo_destino="+ciclo_destino;
        })  
    });
    </script>
    <style type="text/css">
...
<body>
    <div id="container">
        ...
        <header id="titulo" style="min-height: 50px">
            <h3 style="color: #5F7BA9; font-size: 1.5em; font-family: Vernada">Reporte Cantidades x Regional</h3>
        </header>
        <div id="contenido">
            <div class="row">
                <div class="twelve columns">
                    <center>
                        ...
                        <a href="javascript:void(0)" rel="cantidades_bm.php" class="button" id="continuar">Continuar</a>
                    </center>
                </div>
            </div>
        </div>
