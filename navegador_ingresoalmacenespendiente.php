...
echo "<script language='Javascript'>
		...
		function editar_nav(f)
		{
			...
			else
			{
				...
				{
					location.href='registrar_ingresopendiente.php?codigo_registro='+j_cod_registro+'';
				}
			}
		}
		</script>";
	...
	$sql="select s.cod_salida_almacenes, s.cod_almacen, s.fecha, ts.nombre_tiposalida, c.descripcion, a.nombre_almacen, s.observaciones 
	FROM salida_almacenes s, tipos_salida ts, ciudades c, almacenes a 
	where s.cod_tiposalida=ts.cod_tiposalida and s.almacen_destino='$global_almacen' and s.estado_salida=0 and c.cod_ciudad=s.territorio_destino and a.cod_almacen=s.cod_almacen";
	$resp=mysql_query($sql);
	echo "<center><table border='0' class='textotit'><tr><td>Ingresos Pendientes de Material</td></tr></table></center><br>";
	echo "<center><table border='1' class='texto' cellspacing='0' width='100%'>";
	echo "<tr><th>&nbsp;</th><th>Fecha</th><th>Tipo de Salida</th><th>Almacen de Origen</th><th>Observaciones</th><th><table border='1' class='texto' width='100%'><tr><th colspan='3'>Detalle de la Salida</th></tr><tr><th width='80%'>Material</th><th width='20%'>Cantidad</th></tr></table></th></tr>";
	while($dat=mysql_fetch_array($resp))
	{
		...
		echo "<tr><td><input type='checkbox' name='codigo' value='$codigo'></td><td align='center'>$fecha_salida_mostrar</td><td>$nombre_tiposalida</td><td>$nombre_almacen_origen $ciudad_almacen_origen</td><td>&nbsp;$obs_salida</td><td>$txt_detalle</td></tr>";
	}
