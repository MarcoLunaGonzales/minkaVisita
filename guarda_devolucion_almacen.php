...
$sql_inserta=mysql_query("insert into ingreso_almacenes values($codigo,$global_almacen,1001,'$fecha_real','$hora_sistema','Por devolucion de ciclo: $cod_ciclo $cod_gestion. Visitador: $nombreVisitador',1,0,'0','$nro_correlativo',0,0,0)");
// echo("insert into ingreso_almacenes values($codigo,$global_almacen,1001,'$fecha_real','$hora_sistema','Por devolucion de ciclo: $cod_ciclo $cod_gestion. Visitador: $nombreVisitador',1,0,'0','$nro_correlativo',0,0)");
...
{	$cod_material=$tags2[$i];
	...
	$sqlLote="select i.`nro_lote`, i.`fecha_vencimiento` from `salida_detalle_visitador` sv, 
		...
		sv.`codigo_funcionario` in ($cod_visitador) and sv.cod_salida_almacen=si.cod_salida_almacen and sd.cod_material=i.cod_material";
		// echo $sqlLote."<br />";
	...
	$sql_inserta2="insert into ingreso_detalle_almacenes values($codigo,'$cod_material','$nroLote','$fechaVenci',$cantidad,$cantidad,0)";
	// echo $sql_inserta2."<br/>";
