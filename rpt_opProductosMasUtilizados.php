...
{	var rpt_territorio=new Array();
	...
	window.open('rpt_productosMasUtilizados.php?rpt_territorio='+rpt_territorio+'&rpt_nombreTerritorio='+rpt_territorio1+'&rpt_espe='+rpt_espe+'&rpt_espe1='+rpt_espe1+'&rpt_cat='+rpt_cat+'&rpt_cat1='+rpt_cat1+'','','scrollbars=yes,status=yes,toolbar=no,directories=no,menubar=no,resizable=yes,width=1000,height=600');
	return(true);
}
</script>
