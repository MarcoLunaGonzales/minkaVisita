...
echo "<script language='JavaScript'>
		...
		{	var semana, dia_contacto;
			...
			window.open('rpt_contactos_realizados.php?semana='+semana+'&dia_contacto='+dia_contacto+'','','scrollbars=yes,status=no,toolbar=no,directories=no,menubar=no,resizable=yes,width=1000,height=800');			
			return(true);
		}
		...
		{	var semana, dia_contacto;
			semana=f.semana.value;
			dia_contacto=f.dia_contacto.value;
			window.open('rpt_contactos_realizados_xls.php?semana='+semana+'&dia_contacto='+dia_contacto+'','','scrollbars=yes,status=no,toolbar=no,directories=no,menubar=no,resizable=yes,width=1000,height=800');			
			return(true);
		}
		</script>";
...
echo "<center><table class='textotit'><tr><th>Reporte Contactos Realizados</th></tr></table><br>";
