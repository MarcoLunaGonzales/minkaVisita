    ...
    <form action="registro_medico.php" method="post" name="form1">
        <table width="400" border="1" cellpadding="5">
            <tr>
                ...
                <td><input type="text" size="50" id="name" class="name" name="name" placeholder="Nombre del centro m&eacute;dico" /></td>
            </tr>
            <tr>
                <th scope="row">Direccion</th>
                <td><input type="text" size="50" id="direccion" class="direccion" name="direccion" placeholder="Direccion del centro m&eacute;dico" /></td>
            </tr>
            <tr>
        ...
        <table align='center'><tr><td><a href='centro_medico_lista.php'><img  border='0'src='imagenes/volver.gif' width='15' height='8'>Volver Atras</a></td></tr></table>
