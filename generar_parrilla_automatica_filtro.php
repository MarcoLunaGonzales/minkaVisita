...
<head>
    ...
    jQuery(document).ready(function($) {
        $("#vista_previa").click(function(){
            ...
            var windowName = "popUpGPA";//$(this).attr("name");
                    ...
                    <center>
                        <table border="1">
                            <tr>
                                ...
                                <td>
                                    <?php $sql_ciclo = mysql_query("SELECT DISTINCT (c.ciclo), c.gestion, g.nombre_gestion FROM asignacion_mm_excel c, gestiones g WHERE c.gestion = g.codigo_gestion ORDER BY g.codigo_gestion DESC, c.ciclo DESC LIMIT 0, 15") ?>
                        ...
                        <a href="javascript:void(0)" rel="generar_parrilla_automatica.php" class="button" id="vista_previa">Generar Parrilla</a>
                    </center>
                </div>
            </div>
        </div>
