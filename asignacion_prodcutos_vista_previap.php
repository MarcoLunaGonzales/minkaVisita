...
<head>
    ...
    jQuery(document).ready(function($) {
        $("#vista_previa").click(function(){
            ...
            conso = $(".conso:checked").val();
			linea = $("#linea").val();
			
            var url = $(this).attr("rel")+"?ciclo_gestion="+ciclo_gestion+"&conso="+conso+"&linea="+linea;
            var windowName = "popUp_primerp1";//$(this).attr("name");
                    ...
                    <center>
                        <table border="1">
                            <tr>
                                <th>Ciclo - Gestion</th>
                                <td>
                                    <?php $sql_ciclo = mysql_query("SELECT DISTINCT (c.ciclo), c.gestion, g.nombre_gestion FROM asignacion_productos_excel c, gestiones g 
                            ...
                            <tr>
                                <th>Consolidado</th>
                                <td>
                                    <input type="radio" value="1" class="conso" name="conso"> Si
                                    <input type="radio" value="0" class="conso" name="conso"> No
                                </td>
                            </tr>
                        </table> 
