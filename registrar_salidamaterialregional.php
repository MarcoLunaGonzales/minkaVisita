...
echo "</table><br>";
echo"\n<table align='center'><tr><td><a href='navegador_salidamaterialapoyoregional.php'><img  border='0'src='imagenes/volver.gif' width='15' height='8'>Volver Atras</a></td></tr></table>";
