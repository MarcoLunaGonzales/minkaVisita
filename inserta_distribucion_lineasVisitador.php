...
{	require("estilos_inicio_adm.inc");
	...
	$global_gestion_distribucion=1008;
	$global_ciclo_distribucion=8;
	$codVisitadorExtra=1235;
...
//{	
	...
	f.cod_cargo='1011' and f.estado=1 and f.codigo_funcionario=$codVisitadorExtra
