...
$sql_visitadores="select f.codigo_funcionario, f.paterno, f.materno, f.nombres, rc.codigo_linea, rc.codigo_linea, f.cod_zeus, f.cod_ciudad
	...
	where f.codigo_funcionario=rc.cod_visitador and f.cod_ciudad in (102,114,113,104,119,120,116,109,118,117,122,123,124) and f.cod_zeus<>0 and 
	rc.codigo_ciclo='$rpt_ciclo' and rc.codigo_gestion='$global_gestion' and 
	f.codigo_funcionario not in (1211,1383)";
