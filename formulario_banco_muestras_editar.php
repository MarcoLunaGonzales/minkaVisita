...
<body>
    ...
    <div id="container">
        ...
        <section role="main">
            ...
            <div class="row">
                <div class="two columns">
                    <p class="bold">Estado Aprobaci&oacute;n:</p>
                </div>
                <div class="columns end">
                    <?php $sql_aprobado = mysql_query("SELECT nro_visita, ciclo_inicio, ciclo_final, estado from banco_muestras where cod_med = $cod_medico"); ?>
                    <?php  
                        $nro_visita_b = mysql_result($sql_aprobado, 0, 0);
                        $ciclo_inicio_b = mysql_result($sql_aprobado, 0, 1);
                        $ciclo_final_b = mysql_result($sql_aprobado, 0, 2);
                        $estado_b = mysql_result($sql_aprobado, 0, 3);
                    ?>
                    <p>
                        <?php  
                        if($estado_b == 0){echo "No se realizo el c&aacute;lculo para el banco de muestras. <a href=''>Hacerlo aqu&iacute</a>";}
                        if($estado_b == 1){echo "Aprobado";}
                        if($estado_b == 2){echo "Rechazado";}
                        if($estado_b == 3){echo "Pre-Aprobado";}
                        ?>
                    </p>
                </div>
            </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="numero_visita" id="numero_visita">
                                        ...
                                        while ($frecuencia >= 1) {
                                            ?>
                                            <option <?php if($nro_visita_b == $frecuencia): ?>selected<?php endif; ?> value="<?php echo $frecuencia; ?>"><?php echo $frecuencia; ?></option>
                                            <?php
                ...
                <div class="three columns end">
                                ...
                                <td>
                                    <select name="ciclo1" id="ciclo1">
                                        ...
                                        while ($row1 = mysql_fetch_array($sql_ciclo)) {
                                            ...
                                            $nomGestion = $row1[2];
                                            ?>
                                            <option <?php if($ciclo_inicio_b == $codCiclo): ?>selected<?php endif; ?> value="<?php echo $codCiclo; ?>"><?php echo $codCiclo . " " . $nomGestion; ?></option>
                                            <?php } ?>
                                        </select>
                                    </td>
                                </tr>
                                    ...
                                    <td>
                                        <select name="ciclo2" id="ciclo2">
                                            ...
                                            while ($row2 = mysql_fetch_array($sql_ciclo2)) {
                                                ...
                                                $nomGestion1 = $row2[2];
                                                ?>
                                                <option <?php if($ciclo_final_b == $codCiclo1): ?>selected<?php endif; ?> value="<?php echo $codCiclo1; ?>"><?php echo $codCiclo1 . " " . $nomGestion1; ?></option>
                                                <?php } ?>
                                            </select>
                                        </td>
                                    </tr>
                    ...
                    <div class="row">
                        <div class="seven columns">
                            ...
                            <center><input type="button"  value="Modificar" class="boton para_bloquear"> <img src="imagenes/ajax-loader3.gif" alt="" id="loader" /></center>
                        </div>
                    </div>
                </section>
            </div>
