...
echo "<script language='JavaScript'>
		...
		{	var visitador,gestion_rpt, ciclo_rpt;
			...
			window.open('rpt_central_prod_visitador.php?linea_rpt='+linea_rpt+'&visitador='+visitador+'&gestion_rpt='+gestion_rpt+'&ciclo_rpt='+ciclo_rpt+'&rpt_territorio='+rpt_territorio+'','','scrollbars=yes,status=no,toolbar=no,directories=no,menubar=no,resizable=yes,width=1000,height=800');
			return(true);
		}
		...
		{	var visitador,gestion_rpt, ciclo_rpt;
			...
			gestion_rpt=f.gestion_rpt.value;
			ciclo_rpt=f.ciclo_rpt.value;
			window.open('rpt_central_prod_visitador_xls.php?linea_rpt='+linea_rpt+'&visitador='+visitador+'&gestion_rpt='+gestion_rpt+'&ciclo_rpt='+ciclo_rpt+'&rpt_territorio='+rpt_territorio+'','','scrollbars=yes,status=no,toolbar=no,directories=no,menubar=no,resizable=yes,width=1000,height=800');
			return(true);
		}
		</script>";
