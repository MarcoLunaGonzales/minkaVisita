...
<div id="page">
	<div class="header">
		...
		MinkaVentas - <span style="color:orange;">(Modulo Promotor de Ventas)</span>
	...
	<nav id="menu">
		<ul>
			...
			<li><a href="navegadorAcuerdosCom.php" target="contenedorPrincipal">Acuerdos Comerciales</a></li>
