...
echo "<table border='0' class='textotit' align='center'><tr><th>MM - MA Pendiente de Reposicion x Visitador<br>
	...
	{	$cod_prod=$dat_productos[0];
		...
		{	
			...
			$sql_dist_ge="SELECT sum(cantidad_planificada), sum(cantidad_distribuida) , SUM(cantidad_sacadaalmacen) 
				...
				and territorio='$rpt_territorio' and codigo_linea in ($rpt_linea) and cod_visitador='$cod_visitador'
				group by territorio, cod_visitador";
				// echo $sql_dist_ge."<br />";
			...
			// $cad_mostrar.="<td>$sql_dist <br />  $sql_dist_ge <br />  $sql_dist_bm</td>";	
			$cad_mostrar.="<td>$cantidad_faltante_final</td>";
		}
