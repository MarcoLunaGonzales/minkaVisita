...
{	list($cod_territorio,$cod_producto,$cant_a_distribuir)=explode("|",$vector[$i]);
	...
	$sql_visitador="select cod_visitador, cod_med from distribucion_grupos_especiales 
	...
	{	$cod_visitador=$dat_visitadores[0];
		...
		$sql_cantidades="select cantidad_planificada, cantidad_distribuida from distribucion_grupos_especiales
		...
		{	$cant_a_insertar=$maximo_a_insertar+$cant_dist;
			...
			$sql_cantidades="update distribucion_grupos_especiales set cantidad_distribuida='$cant_a_insertar'
