...
echo "<center><table border='0' class='textotit'>
                                            <tr>
                                                <th>Devolucion de MA por Visitador<br>Ciclo: $cod_ciclo Visitador: $nombreVisitador</th>
                                            </tr>
                                        </table></center><br>";
...
while ($datCantidades = mysql_fetch_array($respCantidades)) {
    ...
    echo "<tr>
                                                    ...
                                                    <td align='center'>$cantidadMaterial</td>
                                                    <td align='center'><input type='text' name='$codigoMaterial' size='5' value='$cantidadMaterial' class='texto' $tip></td>
                                             </tr>";
}
