...
$sql_inserta=mysql_query("insert into salida_almacenes values($codigo,$global_almacen,$tipo_salida,'$fecha_real','$territorio','$almacen','$observaciones',0,2,'','',0,'')");
if($funcionario!="")
...
echo "<script language='Javascript'>
			...
			location.href='navegador_salidamaterialapoyoregional.php';
			</script>";
?>