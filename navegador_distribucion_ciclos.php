...
while($dat=mysql_fetch_array($resp))
{
	...
	{	$desc_estado="En Curso"; 
		echo "<tr><td align='center'>$codigo</td><td align='center'>$fecha_inicio</td><td align='center'>$fecha_fin</td><td align='center'>$desc_estado</td>
		<td align='center'><a href='cookie_distribucion.php?codigo_ciclo=$codigo&codigo_gestion=$codigoGestion'>
				<img src='imagenes/go2.png' width='40'>
			</a></td></tr>"; 
	}
	if($estado=="Inactivo")
	{	$desc_estado="Programado";
		echo "<tr><td align='center'>$codigo</td><td align='center'>$fecha_inicio</td>
			<td align='center'>$fecha_fin</td><td align='center'>$desc_estado</td><td align='center'>
			<a href='cookie_distribucion.php?codigo_ciclo=$codigo&codigo_gestion=$codigoGestion'>
				<img src='imagenes/go2.png' width='40'>
			</a></td></tr>"; 
	}
	if($estado=="Cerrado")
	{	$desc_estado="Cerrado"; 
		echo "<tr><td align='center'>$codigo</td><td align='center'>$fecha_inicio</td><td align='center'>$fecha_fin</td><td align='center'>$desc_estado</td><td align='center'>-</td></tr>"; 
	}
	$indice_tabla++;
