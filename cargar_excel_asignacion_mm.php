...
<head>
    ...
    <title>Cargar Excel Asignacion De MM</title>
    ...
    jQuery(document).ready(function($) {
        ...
        $("#continuar").click(function(){
            ...
            $.getJSON("parrilla/cargar_mm.php",{
                "archivo" : archivo,
...
<body>
    <div id="container">
        ...
        <header id="titulo" style="min-height: 50px">
            <h3 style="color: #5F7BA9; font-size: 1.5em; font-family: Vernada">Cargar Excel Asignaci&oacute;n de MM</h3>
        </header>
        <div id="contenido">
            <div class="row">
