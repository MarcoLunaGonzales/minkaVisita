...
<html lang="en-US">
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                $("#cargar").click(function(){
                    $.getJSON("ajax/cargaDevolucion/carga_ma.php",{
    ...
    <center>
        ...
        <h3>Ciclo: <?php echo $cod_ciclos; ?> | Gesti&oacute;n: <?php echo $nombre_gestion; ?></h3>
    </center>
    <?php
...
//    echo $sqlVis;
    ...
    $sql_detalle_codigos_materiales = mysql_query("SELECT a.codigo_material, b.descripcion_material, SUM(a.cantidad_ing_almacen) from devoluciones_ciclodetalle a, material_apoyo b where a.codigo_devolucion
        in  ($codigos_finales) and a.cantidad_devolucion > 0 and a.codigo_material = b.codigo_material GROUP BY 1 ORDER BY 2 ");
    ?>
    <center>
        <table width="70%" border="1">
            ...
            <?php while ($row = mysql_fetch_array($sql_detalle_codigos_materiales)) { ?>
                <?php
                $sql_ingresos = "SELECT sum(id.cantidad_unitaria) from ingreso_almacenes i, ingreso_detalle_almacenes id
			where i.cod_ingreso_almacen=id.cod_ingreso_almacen and i.cod_almacen='$codigo_almacen'
			and id.cod_material='$row[0]' and i.ingreso_anulado=0 and i.grupo_ingreso='2' ";
//                echo $sql_ingresos. "<br />";
			...
			where s.cod_salida_almacenes=sd.cod_salida_almacen and s.cod_almacen='$codigo_almacen'
			and sd.cod_material='$row[0]' and s.salida_anulada=0 and s.grupo_salida='2' ";
//                echo $sql_salidas. "<br />";
                ...
                <tr>
                    ...
                    <td>
                        <?php if ($stock2 >= $row[2]):echo $stock2;
                        else: echo "<span style='color:red; font-weight:bold'>" . $stock2 . "</span>";
                        endif; ?>
                    </td>
                </tr>
<?php } ?>
