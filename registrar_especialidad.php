...
//deben ingresar a este modulo el codigo ciudad y el codigo de medico
	...
	echo "<form name='' action=''>";
		...
		echo "</select></td></tr>";
		echo "</tr></table><input type='hidden' name='h_ciudad' value='$h_ciudad'>";
		echo "<input type='hidden' name='h_cod_med=$h_cod_med'>"
		echo "<input type='button' value='Enviar' class='texto' onClick='enviar_form(this.form)'></form></center>";
