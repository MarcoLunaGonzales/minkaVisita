...
*/
	...
	else
	{
		...
		$sql_inserta="insert into parrilla_especial values ($codigo_parrilla,'$p_ciclo','$p_especialidad',$global_linea,'$fecha_creacion','$fecha_creacion','$j_num_visita','$j_agencia','$j_grupoespe','$j_muestras_extras','$codigo_gestion')";
