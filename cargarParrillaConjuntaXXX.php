...
$sqlLineas="select l.codigo_linea, l.nombre_linea from lineas l where l.codigo_linea=1009";
...
while($datLineas=mysql_fetch_array($respLineas)){
	...
	rc.codigo_ciclo=$codigoCiclo and rc.codigo_linea=$codLinea and f.cod_ciudad=123";
