...
<center>
    <table border='0' class='textotit'>
        <tr>
            <td>M&#233;dicos Solicitados para alta en Sistema</td>
        </tr>
    </table>
</center>
<table align='center'>
...
<center>
    <table border='0' class='texto'>
        <tr>
<!--            <td><a href="adicionar_medico.php" class="boton"  style="padding: 3px 34px; color: #fff !important; text-decoration: none; margin-bottom: 10px">Adicionar</a></td>-->
            <td><a href="#" class="boton editar"  style="padding: 3px 39px; color: #fff !important; text-decoration: none; margin-bottom: 10px">Aprobar</a></td>
            <td><a href="#" class="boton rechazar"  style="padding: 3px 39px; color: #fff !important; text-decoration: none; margin-bottom: 10px">Rechazar</a></td>
<!--                <td><input type='button' value='Eliminar' name='eliminr' class='boton' onclick='eliminar_medico(this.form)'></td>-->
<!--            <td><input type='button' value='Editar' name='Editar' class='boton editar' /></td>-->
        </tr>
    </table>
</center>
<ul class="tabs">
    <li><a href="#tab1">Registrados</a></li>
    <li><a href="#tab2">Pre-Aprobados</a></li>
...
<div class="tab_container">
    <div id="tab1" class="tab_content">
        <center style="padding:10px 0">
            <table border='1' class='textosupermini' cellspacing='0' width='100%'>
                <tr>
                    <th>&nbsp;</th>
                    <th>&nbsp;</th>
                    <th>Codigo</th>
...
//                $sql = mysql_query("SELECT * from medicos where estado_registro = 3 and cod_ciudad = $global_agencia ORDER BY cod_med DESC ");
                $sql = mysql_query("SELECT * from medicos where estado_registro = 3  ORDER BY cod_med DESC ");
                $indice_tabla = 1;
