...
echo "<center><table border=0 class='linea' width='100%'><tr><td align='left'><img src='imagenes/logo_cofar.png'></td><th>Territorio $agencia<br>Funcionario: $nombre_completo Nombre Almacen: $nombre_global_almacen</th></tr></table></center><br>";
*/
echo "<center><table border=0 class='linea' width='100%'><tr><td align='left'><img src='imagenes/logo_cofar.png'></td>
</tr></table></center><br>";
