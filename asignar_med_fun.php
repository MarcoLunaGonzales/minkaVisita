<?php
	...
	echo "<tr><td>&nbsp;Alfabeto</td><td align='center'>
		<a href='asignar_med_alfabeto.php?visitador=$j_funcionario'><img src='imagenes/detalle.png' width='40'></a></td></tr>";
	...
	echo "<tr><td>&nbsp;Codigo</td><td align='center'>
		<a href='asignar_med_ruc.php?visitador=$j_funcionario'><img src='imagenes/detalle.png' width='40'></a></td></tr>";
	echo "</table>";
