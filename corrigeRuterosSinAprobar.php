...
rd.cod_med not in (select c.cod_med from categorias_lineas c where c.cod_med=rd.cod_med and c.codigo_linea=rc.codigo_linea)";
...
while($dat=mysql_fetch_array($resp)){
	...
	if($codEspe!="" and $codCat!=""){
		$sqlDel="delete from categorias_lineas where codigo_linea=$codLinea and cod_med=$codMed";
		...
		$sqlInsert="insert into categorias_lineas values($codLinea, $codMed, '$codEspe', '$codCat',0,0)";
		echo $sqlInsert;
