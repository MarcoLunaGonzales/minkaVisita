...
$codigosTerritorioVector=$_POST['codigosTerritorioVector'];

$codigosCiudades=explode(",",$codigosTerritorioVector);

for($ii=0;$ii<count($codigosCiudades);$ii++){
	$codigo_territorio=$codigosCiudades[$ii];
