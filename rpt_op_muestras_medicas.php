...
//                    alert("dsa");
                    ...
                    var url = "rpt_muestras_medicas.php?tipo="+tipo+"&f_inicio="+fecha_inicio+"&f_final="+fecha_final;
                    var windowName = "Reporte Material Apoyo";
...
//                    alert($(this).attr("name"));
    ...
    <body>
        <div id="container">
            <div id="header">
                <center>
                    <h2>Reporte Ingreso Salida Muestras M&eacute;dicas</h2>
                </center>
            </div>
            <div id="content">
                <center>
