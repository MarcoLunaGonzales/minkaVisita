...
{	var rpt_visitador,rpt_gestion, rpt_ciclo;
	...
	window.open('rpt_distribucionVisitador.php?rpt_visitador='+rpt_visitador+'&rpt_gestion='+rpt_gestion+'&rpt_ciclo='+rpt_ciclo+'&rpt_territorio='+rpt_territorio+'&rpt_ver='+rpt_ver+'','','scrollbars=yes,status=no,toolbar=no,directories=no,menubar=no,resizable=yes,width=1000,height=800');
	return(true);
}
</script>
<?php
...
echo "<center><table class='textotit'><tr><th>Reporte Distribución x Ciclo x Visitador, Linea y Grupos Especiales</th></tr></table><br>";
