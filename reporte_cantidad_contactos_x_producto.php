...
<head>
    ...
    jQuery(document).ready(function($) {
        ...
        $("#continuar").click(function(){
            ...
            var url = "reporte_cantidad_contactos_x_producto_detalle.php?ciclo_gestion="+ciclo_gestion+"&productos="+productos+"&codigos_productos="+str;
            var windowName = "ReporteCantiodad";
        ...
        <div id="contenido">
            <div class="row">
                <div class="twelve columns">
                    <center>
                        <table border="1" style="width:90%;position:relative">
                            <tr id="b">
                                <th>Ciclo - Gestion Destino</th>
                                <td>
                                    <?php $sql_ciclo = mysql_query("SELECT distinct(c.cod_ciclo), g.codigo_gestion, g.nombre_gestion from ciclos c, gestiones g where c.codigo_gestion=g.codigo_gestion order by g.codigo_gestion DESC, c.cod_ciclo DESC LIMIT 12"); ?>
