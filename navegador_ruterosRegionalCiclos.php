...
*/ 
	...
	$sql="select c.`cod_ciclo`, g.`codigo_gestion`, g.`nombre_gestion` from `ciclos` c, gestiones g 	
	...
	while($dat=mysql_fetch_array($resp))
	{
		...
		<td align='center'>
		<a href='navegador_ruterosAprobadosRegional.php?cod_ciclo=$codigo&cod_gestion=$codGestion'>Ver>></a></td></tr>";
	}
