...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
            ...
            $(document).ready(function() {
                ...
                $("#verReporte").click(function(){
                    if($("#medicos").val() == null || $("#medicos").val() == ''){
                        ...
                        var linea  = $("#linea").val();
                        var url = "rpt_diasprogramados.php?codigo_med="+cod_med+"&gestion="+gestion+"&linea="+linea;
                        var windowName = "Reporte Dias programados visita x medico";
    ...
    <body>
        <div id="container">
            <div id="header">
                <center>
                    <h2>D&iacute;as Programados</h2>
                    <h2>Visita por M&eacute;dico</h2>
                </center>
            </div>
            <div id="content">
                <center>
