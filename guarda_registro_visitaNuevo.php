...
$sqlInsertCab  = "INSERT into reg_visita_cab values ($codigo, $contacto, $global_usuario, $cod_med, '$cod_espe', '$cat_med', $codigo_gestion, $ciclo_global, $cod_dia, '$fecha_registro', '$hora_registro', '$fechaVisitaReal', '$parrilla')";
