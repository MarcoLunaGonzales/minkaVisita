	...
	<script>
		...
		jQuery(document).ready(function($) {
			...
			$("#aprobar").click(function(){
				...
				$.getJSON("ajax/sugerencias/aprobar_sup_agre.php",{
					"contactos": checked
				},response);
			...
			function response(datos){
				alert(datos)
				window.location = "solicitud_agregar_productos_pre_supervisor.php"
			}
			$("#rechazar").click(function(){
				...
				$.getJSON("ajax/sugerencias/rechazar_sup_agre.php",{
					"contactos": checked
				},response);
...
<body>
	<div id="container">
		...
		<header id="titulo" style="min-height: 50px">
			<h3 style="color: #5F7BA9; font-size: 1.5em; font-family: Vernada">Productos Agregados Sugeridos</h3>
		</header>
