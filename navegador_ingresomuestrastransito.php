...
s.cod_almacen<>'$global_almacen' and s.grupo_salida='1' and s.estado_salida=1 and s.salida_anulada <> 1 and c.cod_ciudad=s.territorio_destino and a.cod_almacen=s.cod_almacen order by fecha DESC";
// echo $sql;
