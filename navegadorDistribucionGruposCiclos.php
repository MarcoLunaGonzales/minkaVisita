...
<script type="text/javascript">
    $(document).ready(function(){
        $(".efectua_distribucion").click(function(){
            ...
            sendGruposEspeciales(cod_ciclo,cod_gestion)
        })
    })
</script>
<script language='JavaScript'>
    function distribuir(ciclo, gestion)
    {	location.href='efectuarDistribucionGrupos.php?codCiclo='+ciclo+'&codGestion='+gestion+'';
    }
...
$sql = "SELECT distinct(cod_ciclo),codigo_gestion, fecha_ini, fecha_fin, estado from ciclos where codigo_gestion in (1014) 
order by codigo_gestion desc, cod_ciclo desc";
//echo $sql;
$resp = mysql_query($sql);
$indice_tabla = 1;
echo "<center><table border='0' class='textotit'><tr><td>Distribuci&oacute;n de MM y MA para Grupos Especiales</td></tr></table></center><br>";
?>
<div style=" margin: 0 auto; position: relative">
    ...
    echo "<tr><th>Ciclo</th><th>Fecha de Inicio</th><th>Fecha de Fin</th><th>Estado</th><th>&nbsp;</th><th>&nbsp;</th><th>&nbsp;</th>
		<th>&nbsp;</th><th>&nbsp;</th></tr>";
    while ($dat = mysql_fetch_array($resp)) {
		...
		<td align='center'><a href='cookieDistribucion.php?codigo_ciclo=$codigo&codigo_gestion=$codGestion'>Realizar Distribuci&oacute;n >></a></td>
		<td align='center'><a href='javascript:eliminarDist($codigo,$codGestion)'>Eliminar Distribuci&oacute;n >> </a></td>
		<td align='center'><a href='cambiarProductoDistribucionGruposEsp.php?codCiclo=$codigo&codGestion=$codGestion' target='_blank'>Intercambiar MM>></a></td>
                                     <td align='center'><a href='eliminarProductoDistribucion_especial.php?global_linea_distribucion=$codigo' target='_blank'>Eliminar Productos>></a></td>
		<td align='center'>Intercambiar MA>></td>
		...
		<td align='center'>Intercambiar MM >></td>
                                     <td align='center'>Eliminar Productos></td>
		<td align='center'>Intercambiar MA>></td>
