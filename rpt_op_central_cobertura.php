...
{	var rpt_visitador,rpt_gestion, rpt_ciclo;
	...
	window.open('rpt_central_cobertura.php?rpt_visitador='+rpt_visitador+'&rpt_gestion='+rpt_gestion+'&rpt_ciclo='+rpt_ciclo+'&rpt_territorio='+rpt_territorio+'&rpt_linea='+rpt_linea+'&rptNombreLinea='+rpt_nombrelinea+'','','scrollbars=yes,status=no,toolbar=no,directories=no,menubar=no,resizable=yes,width=1000,height=800');
	return(true);
}
</script>
<?php
...
echo "<center><table class='textotit'><tr><th>Reporte Cobertura x Ciclo y Visitador</th></tr></table><br>";
