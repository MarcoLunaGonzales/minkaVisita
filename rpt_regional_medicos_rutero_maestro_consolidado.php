...
{	$rutero_maestro=$vector_ruteros[$i];
	...
	$nom_rutero=$dat[0];
	$nom_linea=$dat[1];
	echo "<th colspan='8'>$nom_linea $nom_rutero</th>";	
}
echo "<th>&nbsp;</th></tr>";
echo "<tr><th>Especialidad</th>";
for($i=0;$i<$n;$i++)
{	echo "<th>Cat A</th><th>Cat B</th><th>Cat C</th><th>Total Medicos</th><th>Cont. A</th><th>Cont. B</th><th>Cont. C</th><th>Sub-total<br>Contactos</th>";
}
...
{	$cod_especialidad=$dat_espe[0];
	...
	rmd.cod_especialidad='$cod_especialidad' order by m.ap_pat_med, m.ap_mat_med, m.nom_med";
		...
		{	$total_medicos_espe=$numero_a+$numero_b+$numero_c;
			...
			$cadena_mostrar.="<td align='center'>$numero_a</td><td align='center'>$numero_b</td><td align='center'>$numero_c</td><td align='center'>$total_medicos_espe</td><td align='center'>$cant_contactos_a</td><td align='center'>$cant_contactos_b</td><td align='center'>$cant_contactos_c</td><td align='center' class='subtotal'>$total_contactos</td>";
			$bandera_mostrar=1;
...
{	$rutero_maestro=$vector_ruteros[$i];
	...
	echo "<th>&nbsp;</th><th>&nbsp;</th><th>&nbsp;</th><th>$filas_medicos</th><th>&nbsp;</th><th>&nbsp;</th><th>&nbsp;</th><th>$filas_contactos</th>";	
}
