...
<head>
    ...
    <title>Consolidado Asignacion de Material De Apoyo</title>
    ...
    jQuery(document).ready(function($) {
        ...
        $("#ciclo").change(function(){
            ...
            $("#overlay").fadeIn();
            $.getJSON("ajax/select/productos_ma.php",{
                "ciclo" : ciclo
            },responsse);
            return false;
        })
        ...
        $("#continuar").click(function(){
            ...
            var url = "consolidado_ma_detalle.php?ciclo_gestion="+ciclo_gestion+"&productos="+productos+"&codigos_productos="+str;
            var windowName = "Consolidado_MA";//$(this).attr("name");
...
<body>
    <div id="container">
        ...
        <header id="titulo" style="min-height: 50px">
            <h3 style="color: #5F7BA9; font-size: 1.5em; font-family: Vernada">Consolidado de Material Apoyo</h3>
        </header>
        <div id="contenido">
            <div class="row">
                    ...
                    <center>
                        <table border="1" style="width:70%;position:relative">
                            <tr id="b">
                                ...
                                <td>
                                    <?php 
									$txtCiclo="SELECT distinct(c.cod_ciclo), c.cod_gestion, g.nombre_gestion 
									from parrilla_personalizada c, gestiones g 
									where c.cod_gestion=g.codigo_gestion order by g.codigo_gestion DESC, c.cod_ciclo desc";
									
									$sql_ciclo = mysql_query($txtCiclo); ?>
