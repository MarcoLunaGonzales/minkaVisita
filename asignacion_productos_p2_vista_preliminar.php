...
<body>
    <div id="container">
        ...
        while ($row_ciudades = mysql_fetch_array($sql_territorios)) {
            ...
            <div class="modal"></div>
            <div id="boton">
                <a href="duplicar_asignacion_productos.php" id="enviar" class="button">
                    Replicar Asignaci&oacute;n
                </a>
            </div>
        </body>
        </html>