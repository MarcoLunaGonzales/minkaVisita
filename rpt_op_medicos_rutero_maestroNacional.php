...
{	var visitador,rutero_maestro;
	...
	window.open('rpt_medicos_rutero_maestroNacional.php?rpt_visitador='+rpt_visitador+'&tipoRuteroRpt='+tipoRuteroRpt+'&gestionCicloRpt='+gestionCicloRpt+'&rpt_linea='+rpt_linea+'&rpt_especialidad='+rpt_especialidad+'','','scrollbars=yes,status=no,toolbar=no,directories=no,menubar=no,resizable=yes,width=1000,height=800');
	return(true);
}
function nuevoAjax()
{	var xmlhttp=false;
...
echo "<center><table class='textotit'><tr><th>M&eacute;dicos en Rutero Maestro Detallado</th></tr></table><br>";
echo"<form method='post'>";
	echo"\n<table class='texto' border='0' align='center' cellSpacing='0' width='40%'>\n";
	echo "<tr><th align='left'>Territorio</th>
	<td>
	<select name='rpt_territorio' class='texto' onChange='ajaxVisitadores(this)' size=11 multiple>";
	...
	echo "<td><select name='rpt_linea' class='texto' size='10' multiple>";
