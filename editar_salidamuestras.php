...
echo "<script language='Javascript'>
	...
	function validar(f)
	{
		...
		location.href='guarda_editarsalidamuestras.php?vector_material='+vector_material+'&vector_fechavenci='+vector_fechavenci+'&vector_cantidades='+vector_cantidades+'&fecha='+fecha+'&tipo_salida='+tipo_salida+'&observaciones='+observaciones+'&cantidad_material='+cantidad_material+'&almacen='+almacen+'&funcionario='+funcionario+'&territorio='+territorio+'&codigo_registro='+codigo_registro+'';
	}
	</script>";
...
{	echo "<tr><td align='center'>$indice_detalle</td>";
	...
	where id.cod_material='$valor_material' and i.cod_ingreso_almacen=id.cod_ingreso_almacen and i.cod_almacen='$global_almacen'";
