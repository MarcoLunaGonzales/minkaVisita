<?php
	...
	echo "<h1>Importar Rutero Maestro<br>Visitador: $nombre_funcionario<br>
	Linea a importar: $nombre_linea<br>Visitador a importar: $nombre_vis_impor</h1>";
	
	echo "<form method='post' action=''>";
	echo "<center><table class='texto'><tr><th>&nbsp;</th><th>Nombre de Rutero</th><th>Estado</th><th>&nbsp;</th></tr>";
	...
	while($dat=mysql_fetch_array($resp))
	{
		...
		echo"<tr><td><input type='checkbox' name='codigo' value='$cod_rutero'></td>
		<td align='center'>$nombre_rutero</td><td align='center'>$estado_desc</td>
		<td align='center'>
		<a href='funcionario_rutero_maestro_importar.php?j_funcionario=$j_funcionario&linea_importada=$linea_importada&rutero_importado=$cod_rutero&visitador_importado=$visitador_importado' target='_blank'>
		<img src='imagenes/go.png' width='40'></a></td></tr>";
	}
	echo "</table><br>";
echo"\n<table align='center'><tr><td><a href='importar_rutero_linea?visitador=$j_funcionario&linea_importada=$linea_importada'><img  border='0'src='imagenes/back.png' width='40'></a></td></tr></table>";
