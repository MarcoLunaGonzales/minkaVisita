...
$sql_medico = mysql_query(" SELECT DISTINCT codigo_funcionario, CONCAT(nombres,' ',paterno,' ',materno) as nombre from funcionarios where cod_ciudad in ($territorio) and cod_cargo = 1011 and estado = 1 ");
