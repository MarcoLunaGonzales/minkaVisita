...
*/
	...
	echo "<center><table border='0' class='textotit'><tr><th>Seleccione la L&iacute;nea con la que desee trabajar</th></tr></table></center><br>";
	echo "<center><table border='1' class='texto' cellspacing='0' width='30%'>";
	echo "<tr><th>L�neas de Productos</th><th>&nbsp;</th></tr>";
	while($dat=mysql_fetch_array($resp))
	{
		...
		if($num_filas!=0)
		{	echo "<tr><td align='left'>&nbsp;&nbsp;$nombre</td><td align='center'><a href='cookie_linea.php?linea=$codigo'>Ingresar >></a></td></tr>";
		}
		else
		{	echo "<tr><td align='left'>&nbsp;&nbsp;$nombre</td><td align='center'>Ingresar >></td></tr>";
		}
	}
