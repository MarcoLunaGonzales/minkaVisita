...
echo "<script language='JavaScript'>
		...
		{	var parametro,gestion_rpt, ciclo_rpt;
			...
			window.open('rpt_parrilla_centralresumen.php?linea_rpt='+linea_rpt+'&gestion_rpt='+gestion_rpt+'&ciclo_rpt='+ciclo_rpt+'&rpt_territorio='+rpt_territorio+'','','scrollbars=yes,status=no,toolbar=no,directories=no,menubar=no,resizable=yes,width=1000,height=600');
			return(true);
		}
		</script>";
