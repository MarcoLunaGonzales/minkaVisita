...
function imprimeRuteroMaestro($codigoGestion, $codigoCiclo, $tipoRuteroRpt, $codigoLinea, $visitador, $idtable) {
...
<tr><th colspan='9'>$nombreVisitador  -  $nombreTerritorio</th></tr>
...
<th>Contactos A</th><th>Contactos B</th><th>Contactos C</th><th>Total Contactos</th>
    ...
    while ($dat_espe = mysql_fetch_array($resp_especialidad)) {
        ...
        $sql_medicos = "select DISTINCT (rmd.cod_med), m.ap_pat_med, m.ap_mat_med, m.nom_med, rmd.categoria_med from $tabla1 rmc, $tabla2 rm, $tabla3 rmd, medicos m where rmc.cod_rutero=rm.cod_rutero and rmc.cod_rutero='$rutero_maestro' and rm.cod_contacto=rmd.cod_contacto and m.cod_med=rmd.cod_med and rmc.codigo_linea='$codigoLinea' and rmc.cod_visitador='$visitador' and rmd.cod_visitador='$visitador' and rmd.cod_especialidad='$cod_especialidad' order by m.ap_pat_med, m.ap_mat_med, m.nom_med";
