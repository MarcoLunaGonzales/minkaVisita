                ...
                <div class="nine columns centered">
                    <table border="1" class="aa">
                        ...
                        <tr>
                            ...
                            ?>
                            <td><?php if($sum_total < $existencia_final){echo "<span style='color:green; font-weight:bold'>".$sum_total."</span>";}else{echo "<span style='color:red; font-weight:bold'>".$sum_total."</span>";} ?></td>
                            <td><?php echo $existencia_final; ?></td>
                            <!-- <td><?php echo $sql_fechas_ingresos."; <br />".$sql_fechas_salidas.";"; ?></td> -->
                        </tr>
                        <?php $count++; ?>
                        <?php } ?>
                    </table>
