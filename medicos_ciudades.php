...
*/
	...
	echo "<tr><td align='center'>Medicos por Territorio<br>Linea: <strong>$nombre_linea</strong></center></td></tr></table><br>";
	...
	while($dat=mysql_fetch_array($resp))
	{
		...
		<a href='cookieTerritoriosMedicos.php?cod_ciudad=$p_cod_ciudad&codigo_linea=$codigo_linea'>Ver >></a></td></tr>";
	}
	echo "</table>";
	echo "<br>";
