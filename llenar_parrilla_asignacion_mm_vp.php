...
<head>
    ...
    jQuery(document).ready(function($) {
            // var url = "llenar_parrilla_asignacion_mm_p1.php";
                    ...
                    <center>
                        <table border="1">
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php $sql_ciclo = mysql_query("SELECT DISTINCT (c.ciclo), c.gestion, g.nombre_gestion FROM asignacion_de_prodcutos c, gestiones g 
                        ...
                        <a href="javascript:void(0)" rel="asignacion_productos_p2_nueva_vista_preliminar.php" class="button" id="continuar">Continuar</a>
                    </center>
                </div>
            </div>
        </div>
