...
function envia_formulario(f) {	
	...
	window.open('rpt_medicos_rutero_maestro2.php?rpt_visitador='+rpt_visitador+'&tipoRuteroRpt='+tipoRuteroRpt+'&gestionCicloRpt='+gestionCicloRpt+'','','scrollbars=yes,status=no,toolbar=no,directories=no,menubar=no,resizable=yes,width=1000,height=800');
	return(true);
}
function nuevoAjax() {	
	var xmlhttp=false;
