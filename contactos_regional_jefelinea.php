...
echo "<table class='textotit' align='center'><tr><th>Contactarme con Jefe de Línea</th></tr></table>";
echo "<form method='post' action='envia_mail_regional.php'>";
echo "<table border='1' class='texto' align='center'>";
echo "<tr><th>Asunto<th><td><input type='text' name='asunto' size='40'></td></tr>";
echo "<tr><th>Mensaje<th><td><textarea name='mensaje' cols='30' rows='10'></textarea></td></tr>";
