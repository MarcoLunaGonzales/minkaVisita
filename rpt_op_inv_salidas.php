...
echo "<script language='JavaScript'>
		...
		{	var rpt_territorio, rpt_almacen, tipo_salida,fecha_ini, fecha_fin, tipo_item, rpt_linea,tipo_reporte;
			...
			window.open('rpt_inv_salidas.php?rpt_territorio='+rpt_territorio+'&rpt_almacen='+rpt_almacen+'&tipo_salida='+tipo_salida+'&rpt_linea='+rpt_linea+'&fecha_ini='+fecha_ini+'&fecha_fin='+fecha_fin+'&tipo_item='+tipo_item+'&tipo_reporte='+tipo_reporte+'','','scrollbars=yes,status=no,toolbar=no,directories=no,menubar=no,resizable=yes,width=1000,height=800');
			return(true);
		}
...
echo"<form method='post' action=''>";
	...
	echo "<option value=''>Todas los tipos</option>";
	...
	echo "<option value='0'>Número de Salida</option>";
