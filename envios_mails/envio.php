...
// $address = "wmanzaneda@cofar.com.bo";
...
// $mail->Subject    = "Solicitud Alta '$territorio' - Visitador '$visitador' ";

// $mail->AltBody    = "Se solicit&oacute; el alta del m&eacute;dico $medico en la regional $territorio el d&iacute;a $dia"; // optional, comment out and test

// $mail->MsgHTML("Estimados Se&ntilde;or@s: <br /> <br />Se solicit&oacute; el alta del m&eacute;dico <strong>$medico</strong> en la regional <strong>$territorio</strong> el d&iacute;a <strong>$dia</strong>. <br /> <br />
