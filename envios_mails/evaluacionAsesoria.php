...
$mail->AddReplyTo("mluna@cofar.com.bo","Solicitud Baja Visitador");

$mail->SetFrom("mluna@cofar.com.bo","Solicitud Baja Visitador");
...
$mail->Subject    = "Evaluación Asesoria en Terreno '$nom_visitador' ";
