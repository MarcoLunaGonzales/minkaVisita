...
echo "<script language='Javascript'>
	...
	{	$sql="select * from contactos where cod_visitador=$global_visitador and ciclo='$ciclo_trabajo' and zona_viaje='1' order by fecha,turno";
	}
	else
	{	$sql="select * from contactos where cod_visitador=$global_visitador and ciclo='$ciclo_trabajo' and zona_viaje='0' order by fecha,turno";
	}
	$resp=mysql_query($sql);
	echo "<center><table border='0' class='textotit'><tr><td align='center'>Registro de Rutero Medico<br>Ciclo de Trabajo.$ciclo_trabajo</td></tr></table></center><br>";
