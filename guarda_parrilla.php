...
*/
	...
	for($k=0;$k<=$num_categorias;$k++)
	{
		...
		$sql_inserta=mysql_query("insert into parrilla values ($codigo_parrilla,'$p_ciclo','$p_especialidad','$categoria[$k]',$global_linea,'$fecha_creacion','$fecha_creacion','$j_num_visita','$j_agencia','$j_linea_visita','$j_muestras_extras','$codigo_gestion', '0')");
		if($sql_inserta!=1)
		{	break;}
