...
?>
<div>	
	<h1>Reporte Avance de Presupuestos Regional x Linea</h1>
...
<div id="main">
<h1>Detalle Avance de Presupuestos Regional x Linea</h1>
<center>
<table class="texto">
	<thead>
		<tr>
	...
	$totalPresupuestoBs=0;
	$totalVentasBs=0;
	$alcanceTotalBs=0;
	
	$totalPresupuestoCant=0;
	$totalVentasCant=0;
	$alcanceTotalCant=0;
	...
	while($dat=mysql_fetch_array($resp)){
		...
		$alcancePresBs=($montoVenta/$montoPresupuesto)*100;
		$alcancePresBsF=formatonumero($alcancePresBs);
		...
		echo "<tr class='textograndenegro'><td>$nombreLinea <a href='reportePresRegProducto.php?linea=$nombreLinea' target='_blank'><img src='imagenes/detalle3.png' width='40' title='Ver x Producto'></a></td>
		<td align='right'>$montoPresupuestoF</td>
		<td align='right'>$montoVentaF</td>
		<td align='center'>$alcancePresBsF %</td>
