...
{	echo "<center><table border='0' class='textotit'><tr><th>Territorio: $nombre_territorio<br>Productos entregados x Visitadores Medicos Gestión: $nombre_cab_gestion Ciclo: $ciclo_rpt</th></tr></table></center><br>";
	...
	echo "<tr><th>Producto</th><th>Cantidad</th><th>Cantidad extra entregada</th><th>Total entregado</th></tr>";
...
and r.codigo_gestion='1004' and rd.orden_visita=rv.orden_visita and r.cod_visitador='$visitador' and r.codigo_linea='$linea_rpt' and rv.muestra='$codigo_muestra'";
...
from registro_visita rv, rutero_detalle rd, rutero r
where r.cod_contacto=rv.cod_contacto and r.cod_contacto=rd.cod_contacto and rd.cod_contacto=rv.cod_contacto and r.cod_ciclo='$ciclo_rpt'
and r.codigo_gestion='1004' and rd.orden_visita=rv.orden_visita and r.cod_visitador='$visitador' and r.codigo_linea='$linea_rpt' and rv.material_apoyo='$codigo_material'";
		...
		{	$cod_material=$matriz_m_m[$i][1];
			...
			if($cantidad_material!=0)
			{	echo "<tr><td align='left'>$nombre_material</td><td align='right'>$cantidad_material </td><td align='right'>$cantidad_extra</td><td align='right'>$total_entregado</td></tr>";
			}
		}
	echo "</table>";
}
...
from registro_visita rv, rutero_detalle rd, rutero r
where r.cod_contacto=rv.cod_contacto and r.cod_contacto=rd.cod_contacto and rd.cod_contacto=rv.cod_contacto and r.cod_ciclo='$ciclo_rpt'
and r.codigo_gestion='1004' and rd.orden_visita=rv.orden_visita and r.cod_visitador='$global_visitador' and r.codigo_linea='$linea_rpt' and rv.muestra='$codigo_muestra'";
		$resp_cantidad_muestras_entregadas=mysql_query($sql_cantidad_muestras_entregadas);
		$dat_cantidad_muestras_entregadas=mysql_fetch_array($resp_cantidad_muestras_entregadas);
		$cantidad_muestra=$dat_cantidad_muestras_entregadas[0];
		$cantidad_extramuestra=$dat_cantidad_muestras_entregadas[1];
		...
		if($cantidad_muestra!=0)
		{	echo "<tr><td align='left'>$descripcion_muestra</td><td align='center'>$cantidad_muestra</td><td align='center'>$cantidad_extramuestra</td><td align='center'>$total_muestrasentregadas</td></tr>";
		}
	}
	$sql_muestras_material="select codigo_material, descripcion_material from material_apoyo order by descripcion_material";
	$resp_muestras_material=mysql_query($sql_muestras_material);
...
from registro_visita rv, rutero_detalle rd, rutero r
where r.cod_contacto=rv.cod_contacto and r.cod_contacto=rd.cod_contacto and rd.cod_contacto=rv.cod_contacto and r.cod_ciclo='$ciclo_rpt'
and r.codigo_gestion='1004' and rd.orden_visita=rv.orden_visita and r.cod_visitador='$global_visitador' and r.codigo_linea='$linea_rpt' and rv.material_apoyo='$codigo_muestra'";
		$resp_cantidad_muestras_entregadas=mysql_query($sql_cantidad_muestras_entregadas);
		$dat_cantidad_muestras_entregadas=mysql_fetch_array($resp_cantidad_muestras_entregadas);
		$cantidad_muestra=$dat_cantidad_muestras_entregadas[0];
		$cantidad_extramuestra=$dat_cantidad_muestras_entregadas[1];
		...
		if($cantidad_muestra!=0)
		{	echo "<tr><td align='left'>$descripcion_muestra</td><td align='center'>$cantidad_muestra</td><td align='center'>$cantidad_extramuestra</td><td align='center'>$total_materialentregado</td></tr>";
		}
	}
	echo "</table>";
}
