...
echo "<table border='0' class='textotit' align='center'><tr><th>Cobertura de Encuestas x Visitador<br>
	...
	$sql_espe="select distinct (m.`cod_espe`) from `medicos_a_encuestar` m where m.`cod_visitador` in ($rpt_visitador) order by m.`cod_espe`";	
