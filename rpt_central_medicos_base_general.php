...
$indice_tabla=1;
	...
	if($filas!=0)
	{
		...
		{	echo "<center><table border='1' class='textomini' cellspacing='0'>";
			if($global_agencia==0) {	
				echo "<tr><th>&nbsp;</th><th>Codigo</th><th>Closeup</th><th>Nombre</th><th>Nacimiento</th><th>Especialidades</th><th>Asignado a</th><th>Direcciones</th><th>Zona</th><th>Distrito</th><th>Teléfonos</th><th>Célular</th><th>Correo Electrónico</th><th>Secretaria</th><th>Perfil Psicografico</th><th>Estado Civil</th><th>Hobbie</th><th>Territorio</th></tr>";
			}
			else {	
				echo "<tr><th>&nbsp;</th><th>Codigo</th><th>Closeup</th><th>Nombre</th><th>Nacimiento</th><th>Especialidades</th><th>Asignado a</th><th>Direcciones</th><th>Zona</th><th>Distrito</th><th>Teléfonos</th><th>Célular</th><th>Correo Electrónico</th><th>Secretaria</th><th>Perfil Psicografico</th><th>Estado Civil</th><th>Hobbie</th></tr>";
			}
		}
	}
