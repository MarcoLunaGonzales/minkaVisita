...
{	var rpt_territorio=new Array();
	...
	var rpt_frecuencia=f.rpt_frecuencia.value;
	var j=0;
	...
	window.open('rpt_medicosDetalleProductos.php?rpt_territorio='+rpt_territorio+'&rpt_nombreTerritorio='+rpt_territorio1+'&rpt_espe='+rpt_espe+'&rpt_espe1='+rpt_espe1+'&rpt_cat='+rpt_cat+'&rpt_cat1='+rpt_cat1+'&rpt_frecuencia='+rpt_frecuencia+'','','scrollbars=yes,status=yes,toolbar=no,directories=no,menubar=no,resizable=yes,width=1000,height=600');
	return(true);
}
</script>
...
echo "<form action='' method='get'>";
	...
	echo "<tr><th align='left'>Frecuencia de Uso</th>
	<td>
	<select name='rpt_frecuencia' class='texto' size='4' multiple>
	<option value='1'>Alta</option>
	<option value='2'>Media</option>
	<option value='3'>Baja</option>
	<option value='4'>No Utiliza</option>
	</select></td></tr>";
