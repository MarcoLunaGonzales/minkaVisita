...
$sql_busca="select paterno, materno, nombres, fecha_nac, especialidad, subespecialidad, direccion1, zona1, telefono, celular, email, 
			direccion2, zona2, direccion3, zona3, hobbie, estado_civil, perfil_psico, secretaria 
			from medicos_sucre order by paterno";
...
{	$paterno=$dat_busca[0];
	...
	$zona2=$dat_busca[12];
	$direccion3=$dat_busca[13];
	$zona3=$dat_busca[14];
	$hobbie=$dat_busca[15];
	$estado_civil=$dat_busca[16];
	$perfil_psico=$dat_busca[17];
	$secretaria=$dat_busca[18];
	...
	$sql_inserta="insert into medicos values('$codigo','$paterno','$materno','$nombres','$fecha_nac','$telefono','$celular','$email','$hobbie','$estado_civil','$secretaria','$perfil_psico','109')";
	...
	{	if($zona3=="NORTE")
		...
		if($zona3=="PADILLA")
		{	$zona_inserto3=1196;}
		$sql_inserta_zonas3="insert into direcciones_medicos values('$codigo','$zona_inserto3','$direccion3','Consultorio III')";
