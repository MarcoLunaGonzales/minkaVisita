...
<html>
<body onload="">
    <table width="100%"  border="0" cellspacing="0" class="textotit"><tr><td align='center'><div align="center">APROBAR MEDICO</div><br></td></tr></table>
    <ul class="tabs">
    ...
    <div class="tab_container">
        ...
        <table align='center'>
            <tr>
                <td>
                    <a href='medicos_solicitados_lista_gerencia.php'><img  border='0'src='imagenes/volver.gif' width='15' height='8'>Volver Atras</a>
                </td>
            </tr>
        </table>
