...
echo "<script language='JavaScript'>
		...
		{	var rpt_territorio,rpt_almacen, tipo_ingreso,fecha_ini, fecha_fin, tipo_item, rpt_linea;
			...
			window.open('rpt_inv_ingresos.php?rpt_territorio='+rpt_territorio+'&rpt_almacen='+rpt_almacen+'&tipo_ingreso='+tipo_ingreso+'&rpt_linea='+rpt_linea+'&fecha_ini='+fecha_ini+'&fecha_fin='+fecha_fin+'&tipo_item='+tipo_item+'','','scrollbars=yes,status=no,toolbar=no,directories=no,menubar=no,resizable=yes,width=1000,height=800');
			return(true);
		}
		...
		{	var rpt_territorio,rpt_almacen, tipo_ingreso,fecha_ini, fecha_fin, tipo_item, rpt_linea;
			...
			tipo_item=f.tipo_item.value;
			rpt_linea=f.rpt_linea.value;
			window.open('rpt_inv_ingresos_xls.php?rpt_territorio='+rpt_territorio+'&rpt_almacen='+rpt_almacen+'&tipo_ingreso='+tipo_ingreso+'&rpt_linea='+rpt_linea+'&fecha_ini='+fecha_ini+'&fecha_fin='+fecha_fin+'&tipo_item='+tipo_item+'','','scrollbars=yes,status=no,toolbar=no,directories=no,menubar=no,resizable=yes,width=1000,height=800');
			return(true);
		}
