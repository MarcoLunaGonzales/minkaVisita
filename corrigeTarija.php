...
where c.cod_med in (select cod_med from medicos where cod_ciudad=118) and cod_especialidad='MGE'";
...
while($dat=mysql_fetch_array($resp)){
	...
	$sqlLineas="select f.codigo_funcionario, fl.codigo_linea from 
		...
		f.estado=1 and f.cod_ciudad=118 and fl.codigo_linea in (1041) and f.codigo_funcionario=1302";
