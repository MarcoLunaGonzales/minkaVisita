...
echo "<script language='Javascript'>
	...
	$sql="select * from rutero_maestro where cod_visitador=$visitador and cod_rutero='$rutero' and dia_contacto='$dia_contacto' order by turno";
	$resp=mysql_query($sql);
	echo "<center><table border='0' class='textotit'><tr><th>Registro de Rutero Medico Maestro<br>Visitador: $nombre_funcionario<br>Número de Rutero: $rutero</td></tr></table></center><br>";
