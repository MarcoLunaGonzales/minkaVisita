...
echo "<script language='Javascript'>
	...
	function validar(f)
	{
		...
		location.href='guarda_ingresomuestras.php?vector_material='+vector_material+'&vector_nrolote='+vector_nrolote+'&vector_fechavenci='+vector_fechavenci+'&vector_cantidades='+vector_cantidades+'&fecha='+fecha+'&tipo_ingreso='+tipo_ingreso+'&observaciones='+observaciones+'&cantidad_material='+cantidad_material+'&vector_tipomaterial='+vector_tipomaterial+'&nota_entrega='+nota_entrega+'';
	}
	</script>";
...
echo "</table><br>";
echo"\n<table align='center'><tr><td><a href='navegador_ingresomuestras.php'><img  border='0'src='imagenes/volver.gif' width='15' height='8'>Volver Atras</a></td></tr></table>";
