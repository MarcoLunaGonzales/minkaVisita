...
for ($ii=1; $ii<=5; $ii++){
	...
	while($datAreas=mysql_fetch_array($respAreas)){
		...
		echo $cadTiposBaja;
		echo "<td align='center' bgcolor='$colorBaja'>$numeroBajas</td>
	...
	echo $cadTiposBaja;
	echo "<th bgcolor='$colorBaja'>$totalBajaContactosSemana</th><th>-</th><th>$totalCumplimientoSemana %</th><th>$totalCoberturaSemana %</th></tr>";
}
