...
{	$sql="select r.cod_contacto, r.dia_contacto, r.turno from rutero r, orden_dias o where r.dia_contacto=o.dia_contacto and o.id<$id_sistema and r.cod_ciclo='$ciclo_global' and r.cod_visitador='$global_visitador' order by o.id";
	...
	echo "<center><table border='0' class='textotit'><tr><th>Productos Entregados</th></tr></table></center><br>";
	...
	while($dat=mysql_fetch_array($resp))
	{
		...
		{	$sql_detalle="select orden_visita, cod_med, cod_especialidad, categoria_med from rutero_detalle where cod_contacto='$cod_contacto' and estado='1' order by orden_visita";
			...
			{	$orden_visita=$dat_detalle[0];
				...
				$productos_entregados.="<table class='textomini' width='100%' border=1><tr><th width='50%'>Producto</th><th width='10%'>Cantidad</th><th width='30%'>Material Apoyo</th><th width='10%'>Cantidad</th></tr>";	
			...
			echo "<tr><td align='center'>$dia_contacto<br>$turno</td><td align='center'>$medicos_visitados</td></tr>";		
		}
	}
...
{	$consulta_semana="(r.dia_contacto='Lunes $semana' or r.dia_contacto='Martes $semana' or r.dia_contacto='Miercoles $semana' or r.dia_contacto='Jueves $semana' or r.dia_contacto='Viernes $semana')";
	...
	$resp=mysql_query($sql);
	echo "<center><table border='0' class='textotit'><tr><th>Productos Entregados<br> Semana $semana</th></tr></table></center><br>";
	echo "<center><table border='1' class='textomini' width='100%' cellspacing='0'>";
	echo "<tr><th>Dia Contacto</th><th>Medicos</th></tr>";
	while($dat=mysql_fetch_array($resp))
	{
...
{	$sql="select r.cod_contacto, r.dia_contacto from rutero r, orden_dias o where r.dia_contacto='$dia_contacto' and r.dia_contacto=o.dia_contacto and o.id<$id_sistema and r.cod_ciclo='$ciclo_global' and r.cod_visitador='$global_visitador' order by o.id";
	$resp=mysql_query($sql);
	echo "<center><table border='0' class='textotit'><tr><th>Productos Entregados<br>Dia de Contacto $dia_contacto</th></tr></table></center><br>";
	echo "<center><table border='1' class='textomini' width='100%' cellspacing='0'>";
