...
{	var rpt_visitador,rpt_gestion, rpt_ciclo;
	...
	if(rpt_reporte==0){
		window.open('rptCoberturaSemana.php?rpt_nombreterritorio='+rpt_nombreterritorio+'&rpt_territorio='+rpt_territorio+'&rpt_gestion='+rpt_gestion+'&rpt_ciclo='+rpt_ciclo+'&rpt_categoria='+rpt_categoria,'','scrollbars=yes,status=no,toolbar=no,directories=no,menubar=no,resizable=yes,width=1000,height=800');
	}
	if(rpt_reporte==1){
		window.open('rptCoberturaSemanaArea.php?rpt_nombreterritorio='+rpt_nombreterritorio+'&rpt_territorio='+rpt_territorio+'&rpt_gestion='+rpt_gestion+'&rpt_ciclo='+rpt_ciclo+'&rpt_categoria='+rpt_categoria,'','scrollbars=yes,status=no,toolbar=no,directories=no,menubar=no,resizable=yes,width=1000,height=800');
	}	
	return(true);
}
...
echo"<form method='post'>";
	...
	<option value='0'>General Por Dia</option>
	<option value='1'>Por Dia y Territorio</option>
	</select></td></tr>";
