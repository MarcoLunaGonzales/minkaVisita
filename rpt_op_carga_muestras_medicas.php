...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head>
        <title>Cargar Reporte Ingreso Salida Muestras M&eacute;dicas</title>
    ...
    <body>
        <div id="container">
            <div id="header">
                <center>
                    <h2>Cargar Reporte Ingreso Salida Muestras M&eacute;dicas</h2>
                </center>
            </div>
            <div id="content">
                <center>
                ...
                <center>
                    <a href="#" class="button" style="padding: 8px 16px" id="exportar">Exportar a Zeus</a>
                </center>
                <center>
                    <div id="faltantes">
