...
for($i=0;$i<$total;$i++)
{
    ...
    $sql_det_ingreso="
        ...
        WHERE i.cod_ingreso_almacen=id.cod_ingreso_almacen AND i.cod_almacen='$codigo_almacenarreglar' AND i.grupo_ingreso='2'
    ...
    $sql_salida_detalle="
        ...
        WHERE s.cod_salida_almacenes=sd.cod_salida_almacen AND s.cod_almacen='$codigo_almacenarreglar' AND s.grupo_salida=2
    ...
    $sql_salida_detalle="
        SELECT sd.cod_salida_almacen, sd.cod_material, sd.cantidad_unitaria, s.grupo_salida
        FROM salida_detalle_almacenes sd, salida_almacenes s
        WHERE s.cod_salida_almacenes=sd.cod_salida_almacen AND s.cod_almacen='$codigo_almacenarreglar' AND s.grupo_salida=2 AND s.salida_anulada=0
        and sd.cod_material='$codigo_material'";
    $resp_salida_detalle=mysql_query($sql_salida_detalle);
    while($dat_salida_detalle=mysql_fetch_array($resp_salida_detalle))
    {   $cod_salida_almacen=$dat_salida_detalle[0];
