...
function validar(f)
	...
	require('inicio_administracion.php');
echo "<table class='textotit' align='center'><tr><th>Contactarme con Administrador HERMES</th></tr></table>";
echo "<form method='post' action='envia_mail.php' ENCTYPE='multipart/form-data'>";
echo "<input type='hidden' name='destinatario' value='sistemas2@cofar.com.bo'>";
