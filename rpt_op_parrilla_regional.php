...
echo "<script language='JavaScript'>
		...
		{	var parametro,gestion_rpt, ciclo_rpt, linea_rpt;
			var rpt_territorio;
			linea_rpt=f.linea_rpt.value;
			rpt_territorio=f.rpt_territorio.value;
			parametro=f.parametro.value;
			gestion_rpt=f.gestion_rpt.value;
			ciclo_rpt=f.ciclo_rpt.value;;
			window.open('rpt_parrilla_central_xls.php?linea_rpt='+linea_rpt+'&cod_especialidad='+parametro+'&parametro='+parametro+'&gestion_rpt='+gestion_rpt+'&ciclo_rpt='+ciclo_rpt+'&rpt_territorio='+rpt_territorio+'','','scrollbars=yes,status=no,toolbar=no,directories=no,menubar=no,resizable=yes,width=1000,height=600');
			return(true);
		}
		</script>";
