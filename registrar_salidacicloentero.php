...
echo "<script language='Javascript'>
	...
	function validar(f)
	{	var indice, nro_materiales,codigo_ciclo, codigo_linea, cod_visitador,cod_territorio, grupo_salida;
		...
		location.href='guarda_salidacicloentero.php?vector_material='+vector_material+'&vector_cantidadesplanificadas='+vector_cantidadesplanificadas+'&vector_cantidades='+vector_cantidades+'&fecha='+fecha+'&tipo_salida='+tipo_salida+'&nro_materiales='+nro_materiales+'&observaciones='+observaciones+'&codigo_ciclo='+codigo_ciclo+'&codigo_linea='+codigo_linea+'&cod_visitador='+cod_visitador+'&cod_territorio='+cod_territorio+'&grupo_salida='+grupo_salida+'';
	}
	</script>";
...
echo "<tr><th>&nbsp;</th><th>Material</th><th>Cantidad Planificada</th><th>Cantidad Unitaria</th><th>Stock</th></tr>";
$indice_detalle=1;
...
{	$cod_material=$matriz_m_m[$i][1];
	...
	where id.cod_material='$cod_material' and i.cod_ingreso_almacen=id.cod_ingreso_almacen and i.ingreso_anulado=0 and i.cod_almacen='1000'";
	...
	$nombre_material="$dat_material[0] $dat_material[1]";
	...
	{	//echo "<tr><td align='left'>$nombre_material</td><td align='rigth'>$cantidad_material</td></tr>";
		...
		echo "<td align='center'><input type='text' name='cantidad_unitaria$indice_detalle' value='$cantidad_material' class='texto' onKeypress='if (event.keyCode < 48 || event.keyCode > 57 ) event.returnValue = false;'></td>";
		if($stock_real=="")
		{	$stock_real=0;
		}
...
echo "</table><br>";
echo"\n<table align='center'><tr><td><a href='navegador_salidaciclosenterosterritorios.php?codigo_ciclo=$codigo_ciclo'><img  border='0' src='imagenes/back.png' width='40'></a></td></tr></table>";
