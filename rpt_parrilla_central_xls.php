...
require("estilos_reportes_central_xls.inc");
	...
	$cod_ciclo=$dat[0];
	if($rpt_territorio==0)
	{	echo "<center><table border='0' class='textotit'><tr><th>Parrillas Promocionales<br>Gestión: $nombre_cab_gestion Ciclo: $ciclo_rpt</th></tr></table></center><br>";
	}
	else
	{	echo "<center><table border='0' class='textotit'><tr><th>Parrillas Promocionales<br>Territorio: $nombre_territorio<br>Gestión: $nombre_cab_gestion Ciclo: $ciclo_rpt</th></tr></table></center><br>";
	}
	...
	while($dat_agencia=mysql_fetch_array($resp_agencia))
	{
		...
		if($cod_especialidad=="")
		{	$sql="select * from parrilla where agencia=$cod_ciudad and codigo_linea=$global_linea and cod_ciclo='$ciclo_rpt' and codigo_gestion='$gestion_rpt' order by cod_ciclo,cod_especialidad,categoria_med,numero_visita";
		}
		else
		{	$sql="select * from parrilla where cod_especialidad='$cod_especialidad' and agencia=$cod_ciudad and codigo_linea=$global_linea and cod_ciclo='$ciclo_rpt' and codigo_gestion='$gestion_rpt' order by cod_ciclo,cod_especialidad,categoria_med,numero_visita";
		}
		...
		{	echo "<table align='center' class='texto'><tr><th>$descripcion_ciudad</th></tr></table>";
			...
			echo "<tr><th>Especialidad</th><th>Categoria</th><th>Visita</th><th>Parrilla Promocional</th></tr>";
			while($dat=mysql_fetch_array($resp))
			{
				...
				echo "<tr><td align='center'>$cod_espe</td><td align='center'>$cod_cat</td><td align='center'>$numero_de_visita</td><td align='center'>$parrilla_medica</td></tr>";
			}
