...
echo "<script language='JavaScript'>
		...
		{	var parametro,visitador,gestion_rpt, ciclo_rpt;
			...
			window.open('rpt_central_maestro_vs_ejecutado.php?linea_rpt='+linea_rpt+'&visitador='+visitador+'&parametro='+parametro+'&gestion_rpt='+gestion_rpt+'&ciclo_rpt='+ciclo_rpt+'&rpt_territorio='+rpt_territorio+'&rpt_dia_inicio='+dia_inicio_rpt+'&rpt_dia_final='+dia_final_rpt+'','','scrollbars=yes,status=no,toolbar=no,directories=no,menubar=no,resizable=yes,width=1000,height=800');
			return(true);
		}
		...
		{	var parametro,visitador,gestion_rpt, ciclo_rpt;
			...
			dia_inicio_rpt=f.dia_inicio.value;
			dia_final_rpt=f.dia_final.value;
			window.open('rpt_central_maestro_vs_ejecutado_xls.php?linea_rpt='+linea_rpt+'&visitador='+visitador+'&parametro='+parametro+'&gestion_rpt='+gestion_rpt+'&ciclo_rpt='+ciclo_rpt+'&rpt_territorio='+rpt_territorio+'&rpt_dia_inicio='+dia_inicio_rpt+'&rpt_dia_final='+dia_final_rpt+'','','scrollbars=yes,status=no,toolbar=no,directories=no,menubar=no,resizable=yes,width=1000,height=800');
			return(true);
		}
		</script>";
