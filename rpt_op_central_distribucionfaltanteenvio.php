...
echo "<script language='JavaScript'>
		...
		{	var rpt_visitador,rpt_gestion, rpt_ciclo;
			...
			window.open('rpt_central_distribucionfaltanteenvio.php?rpt_visitador='+rpt_visitador+'&rpt_gestion='+rpt_gestion+'&rpt_ciclo='+rpt_ciclo+'&rpt_territorio='+rpt_territorio+'','','scrollbars=yes,status=no,toolbar=no,directories=no,menubar=no,resizable=yes,width=1000,height=800');
			return(true);
		}
		...
		{	var rpt_visitador,rpt_gestion, rpt_ciclo;
			...
			rpt_gestion=f.gestion_rpt.value;
			rpt_ciclo=f.ciclo_rpt.value;
			window.open('rpt_central_distribucionfaltanteenvio_xls.php?rpt_visitador='+rpt_visitador+'&rpt_gestion='+rpt_gestion+'&rpt_ciclo='+rpt_ciclo+'&rpt_territorio='+rpt_territorio+'','','scrollbars=yes,status=no,toolbar=no,directories=no,menubar=no,resizable=yes,width=1000,height=800');
			return(true);
		}
		</script>";
