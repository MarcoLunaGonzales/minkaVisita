...
while ( $datMedicos = mysql_fetch_array( $respMedicos ) ) {
	...
	if ( $hojas % 2 != 0 ) {
		...
		$txt1 = "Boleta de Categorizaci&oacute;n de M&eacute;dicos";
		$pdf->SetXY( 10, 15 );
		...
		$pdf->SetXY( 10, 87 );
		$pdf->Cell( 80, 5, "Nro. de pacientes d&iacute;a en el lugar de visita", 0, 2, "L" );
		$pdf->SetXY( 115, 87 );
		$pdf->SetFillColor( 248, 232, 219 );
		$pdf->Cell( 30, 5, "", 1, 2, "C", true );
		...
		$pdf->SetXY( 10, 108 );
		$pdf->Cell( 80, 5, "Nivel Sociecon&oacute;mico de los Pacientes", 0, 2, "L" );
		$pdf->SetXY( 115, 108 );
		$pdf->SetFillColor( 248, 232, 219 );
		$pdf->Cell( 20, 5, "", 1, 2, "C", true );
		$pdf->SetXY( 140, 108 );
