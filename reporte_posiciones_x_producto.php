...
<head>
    ...
    jQuery(document).ready(function($) {
        ...
        $("#continuar").click(function(){
            ...
            var url = "analisis_productos_especialidad.php?ciclo_gestion="+ciclo_gestion+"&productos="+productos+"&codigos_productos="+str;
            var windowName = "Analisis";//$(this).attr("name");
