...
{	$cod_material=$vector_material[$i];
	...
	$txtinsertadetalle="insert into ingreso_detalle_almacenes values
	($codigo,'$cod_material','$numero_lote','$fecha_sistema_vencimiento',$cantidad,$cantidad,'0')";
	//echo $txtinsertadetalle;
	$sql_inserta2=mysql_query($txtinsertadetalle);
}
