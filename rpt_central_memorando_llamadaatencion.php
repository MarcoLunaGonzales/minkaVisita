...
//fin sacar dia contacto actual
	...
	$sql_territorio="select cod_ciudad,descripcion from ciudades";
	$resp_territorio=mysql_query($sql_territorio);
while($datos_territorio=mysql_fetch_array($resp_territorio))
{	$rpt_territorio=$datos_territorio[0];
	$nombre_territorio=$datos_territorio[1];
	...
	{	$global_linea=$datos_linea[0];
		$nombre_linea=$datos_linea[1];
		...
		$indice_tabla=1;
		$numero_visitadores=mysql_num_rows($resp_visitador);
		...
		{	while($dat_visitador=mysql_fetch_array($resp_visitador))
			{	$codigo_visitador=$dat_visitador[0];
				...
				where r.cod_ciclo='$ciclo_rpt' and r.codigo_gestion='$gestion_rpt' and r.cod_visitador='$codigo_visitador' and r.codigo_linea='$global_linea' and r.cod_contacto=rd.cod_contacto";
				...
				if($cobertura_real<70)
				{	echo "<table align='center' width='90%' border='0'>";
					echo "<tr><td>&nbsp;</td></tr>";
					echo "<tr><td>&nbsp;</td></tr>";
					echo "<tr><td>&nbsp;</td></tr>";
					echo "<tr><td align='right'>La Paz, 20 de Junio de 2007</td></tr>";
					echo "<tr><td>&nbsp;</td></tr>";
					echo "<tr><td align='left'>Sr(a): $nombre_visitador<br>Ref.- Memorando de Llamada de Atención</td></tr>";
					echo "<tr><td>&nbsp;</td></tr>";
					echo "<tr><td align='left'>Lamentablemente usted no ha alcanzado el porcentaje mínimo de cobertura del 85% estipulado por la empresa,
					siendo el porcentaje objetivo mínimo del 90%. Por este motivo se le extiende el presente <strong>Memorando de Llamada de Atención</strong>, exhortándole
					a enmendar su falta y mejorar su desempeño.</td></tr>";
					echo "<tr><td>&nbsp;</td></tr>";
					echo "<tr><td>";
					...
					echo "</td></tr>";
					echo "<tr><td>&nbsp;</td></tr>";
					echo "<tr><td>Seguros de que tendra muy en cuenta esta llamada de atención, me despido.</td></tr>";					
					echo "<tr><td>&nbsp;</td></tr>";
					echo "<tr><td>&nbsp;</td></tr>";
					echo "<tr><td>Atentamente,</td></tr>";
					echo "<tr><td>&nbsp;</td></tr>";
					echo "<tr><td>Dr. Miguel Pacheco<br>JEFE NACIONAL DE PROMOCIÓN MEDICA<br>LABORATORIOS COFAR S.A.-BOLIVIA</td></tr>";
					echo "<tr><td>&nbsp;</td></tr>";
					echo "<tr><td>cc. Recursos Humanos<br>File Personal<td></tr>";
					echo "<tr><td>&nbsp;</td></tr>";
					echo "<tr><td>&nbsp;</td></tr>";
					echo "<tr><td>&nbsp;</td></tr>";
					echo "<tr><td>&nbsp;</td></tr>";
