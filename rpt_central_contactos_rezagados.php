...
require("estilos_reportes_central.inc");	
	$sql_ciclo="select cod_ciclo, codigo_gestion from ciclos where estado='Activo' and codigo_linea='$global_linea'";
	$resp_ciclo=mysql_query($sql_ciclo);
	$datos_ciclo=mysql_fetch_array($resp_ciclo);
	$ciclo_global=$datos_ciclo[0];
	$codigo_gestion=$datos_ciclo[1];
...
$bandera=0;
//este primer if saca el reporte por medico resumido
