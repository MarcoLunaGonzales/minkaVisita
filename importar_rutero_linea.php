<?php
	...
	echo "<h1>Importar Rutero Maestro<br>Visitador: $nombre_funcionario
	<br>Linea a importar: $nombre_linea</h1>";
	...
	{	$codigo_funcionario=$dat[0];
		...
		echo "<tr><td>&nbsp$nombre_funcionario</td><td align='center'>
		<a href='importar_rutero_visitador.php?j_funcionario=$visitador&linea_importada=$linea_importada&visitador_importado=$codigo_funcionario'>
		<img src='imagenes/go.png' width='40'></a></td></tr>";	
	}
	echo "</table><br>";
	echo"\n<table align='center'><tr><td><a href='importar_rutero_maestro.php?j_funcionario=$visitador'><img  border='0'src='imagenes/back.png' width='40'></a></td></tr></table>";	
?>