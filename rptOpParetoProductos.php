...
{	var rpt_fechaini, rpt_fechafin, rpt_ver;
	...
	window.open('rptParetoProductos.php?rpt_promotor='+rpt_promotor+'&rpt_linea='+rpt_linea+'&rpt_territorio='+rpt_territorio+'&rpt_fechaini='+rpt_fechaini+'&rpt_fechafin='+rpt_fechafin+'&rpt_canal='+rpt_canal+'&rpt_ver='+rpt_ver,'','scrollbars=yes,status=no,toolbar=no,directories=no,menubar=no,resizable=yes,width=1000,height=800');
	return(true);
}
...
echo "<center><h1>Reporte Pareto de Productos</h1><br>";
