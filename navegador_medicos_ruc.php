...
*/
	...
	while($dat=mysql_fetch_array($resp))
	{
		...
		echo "<tr><td align='center'>$indice_tabla</td><td align='center'><input type='checkbox' name='codigos_ciclos' value=$cod></td><td align='center'>$cod</td><td align='center' class='texto'>$nombre_completo</td><td align='center'>&nbsp;$especialidad</td><td align='center'>$prod_obj</td><td align='center'>$prod_fil</td></tr>";
		$indice_tabla++;
	}
