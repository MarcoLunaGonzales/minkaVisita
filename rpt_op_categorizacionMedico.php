            ...
            $(function() {
                $("#enviar").click(function(event){
                    ...
                    if(territorio == '' || territorio == null){
                        ...
                        var url = "rpt_categorizacionmedico.php?territorio="+territorio+"&formato="+formato;
                ...
                <center>
                    <table border="1" width="30%" cellpadding="5" id="filtro">
                        ...
                        <tr>
                            ...
                            <td>
                                Resumido
                                <input type="radio" checked="" value="resumido" name="formato" />
                                Detallado
                                <input type="radio" value="detallado" name="formato" />
                            </td>
                        </tr>
                    </table>
                </center>
