<script language='JavaScript'>
    ...
    {	var rpt_visitador,rpt_gestion, rpt_ciclo;
        ...
        window.open('rpt_central_distribucion2.php?rpt_visitador='+rpt_visitador+'&rpt_gestion='+rpt_gestion+'&rpt_ciclo='+rpt_ciclo+'&rpt_territorio='+rpt_territorio+'&rpt_linea='+rpt_linea+'&rptNombreLinea='+rpt_nombrelinea+'&rpt_ver='+rpt_ver+'','','scrollbars=yes,status=no,toolbar=no,directories=no,menubar=no,resizable=yes,width=1000,height=800');
        return(true);
    }
</script>
<?php
...
echo "<center><table class='textotit'><tr><th>Reporte Distribucion x Ciclo x Visitador</th></tr></table><br>";
