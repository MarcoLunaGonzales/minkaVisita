...
<head>
    ...
    jQuery(document).ready(function($) {
        ...
        $("#continuar").click(function(){
            ...
            var url = "reporte_asignacion_mm2.php?ciclo_gestion="+ciclo_gestion+"&productos="+productos+"&codigos_productos="+str;
...
<body>
    <div id="container">
        ...
        <header id="titulo" style="min-height: 50px">
            <h3 style="color: #5F7BA9; font-size: 1.5em; font-family: Vernada">Nro de medicos y contactos x cada producto principal x ciclo</h3>
        </header>
        <div id="contenido">
            <div class="row">
