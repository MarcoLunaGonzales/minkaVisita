...
require("imprimeRuteroMaestroConsolidado.php");
...
for($i=0;$i<=$tamanoVector-1;$i++){
	...
	imprimeRuteroMaestro($codigoGestion,$codigoCiclo,$tipoRuteroRpt,$codigoVisitador,$i,$rpt_zonas);
	echo "<br>";
}
?>